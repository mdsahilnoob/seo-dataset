<!DOCTYPE html>
<html lang="en" dir="ltr" data-theme="dark" data-has-sidebar data-has-hero class="astro-gk6ncezd">
	<head>
		<meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><title>Getting started | Docs</title><link rel="canonical" href="https://docs.astro.build/en/getting-started/"/><link rel="alternate" hreflang="en" href="https://docs.astro.build/en/getting-started/"/><link rel="alternate" hreflang="de" href="https://docs.astro.build/de/getting-started/"/><link rel="alternate" hreflang="pt-BR" href="https://docs.astro.build/pt-br/getting-started/"/><link rel="alternate" hreflang="es" href="https://docs.astro.build/es/getting-started/"/><link rel="alternate" hreflang="zh-CN" href="https://docs.astro.build/zh-cn/getting-started/"/><link rel="alternate" hreflang="zh-TW" href="https://docs.astro.build/zh-tw/getting-started/"/><link rel="alternate" hreflang="fr" href="https://docs.astro.build/fr/getting-started/"/><link rel="alternate" hreflang="hi" href="https://docs.astro.build/hi/getting-started/"/><link rel="alternate" hreflang="ar" href="https://docs.astro.build/ar/getting-started/"/><link rel="alternate" hreflang="ja" href="https://docs.astro.build/ja/getting-started/"/><link rel="alternate" hreflang="ko" href="https://docs.astro.build/ko/getting-started/"/><link rel="alternate" hreflang="pl" href="https://docs.astro.build/pl/getting-started/"/><link rel="alternate" hreflang="ru" href="https://docs.astro.build/ru/getting-started/"/><link rel="alternate" hreflang="it" href="https://docs.astro.build/it/getting-started/"/><link rel="sitemap" href="/sitemap-index.xml"/><link rel="icon" href="/favicon.ico" sizes="32x32"/><link rel="shortcut icon" href="/favicon.svg" type="image/svg+xml"/><meta name="generator" content="Astro v5.16.6"/><meta name="generator" content="Starlight v0.37.1"/><meta property="og:title" content="Getting started"/><meta property="og:type" content="article"/><meta property="og:url" content="https://docs.astro.build/en/getting-started/"/><meta property="og:locale" content="en"/><meta property="og:description" content="Guides, resources, and API references to help you build with Astro — the web framework for content-driven websites."/><meta property="og:site_name" content="Docs"/><meta name="twitter:card" content="summary_large_image"/><meta name="description" content="Guides, resources, and API references to help you build with Astro — the web framework for content-driven websites."/><meta property="og:image" content="https://docs.astro.build/open-graph/en/getting-started.webp"/><meta name="twitter:image" content="https://docs.astro.build/open-graph/en/getting-started.webp"/><meta name="twitter:site" content="astrodotbuild"/><meta name="docsearch:language" content="en"/><script src="https://cdn.usefathom.com/script.js" data-site="EZBHTSIG" data-canonical="true" defer></script>
...
<script type="module">const r="starlight-theme",o=e=>e==="auto"||e==="dark"||e==="light"?e:"auto",c=()=>o(typeof localStorage<"u"&&localStorage.getItem(r));function n(e){typeof localStorage<"u"&&localStorage.setItem(r,e==="light"||e==="dark"?e:"")}const l=()=>matchMedia("(prefers-color-scheme: light)").matches?"light":"dark";function t(e){StarlightThemeProvider.updatePickers(e),document.documentElement.dataset.theme=e==="auto"?l():e,n(e)}matchMedia("(prefers-color-scheme: light)").addEventListener("change",()=>{c()==="auto"&&t("auto")});class s extends HTMLElement{constructor(){super(),t(c()),this.querySelector("select")?.addEventListener("change",a=>{a.currentTarget instanceof HTMLSelectElement&&t(o(a.currentTarget.value))})}}customElements.define("starlight-theme-select",s);</script>
	...
	<select autocomplete="off" class="astro-ejfgzp5e">
		<option value="/en/getting-started/" selected class="astro-ejfgzp5e">English</option><option value="/de/getting-started/" class="astro-ejfgzp5e">Deutsch</option><option value="/pt-br/getting-started/" class="astro-ejfgzp5e">Português do Brasil</option><option value="/es/getting-started/" class="astro-ejfgzp5e">Español</option><option value="/zh-cn/getting-started/" class="astro-ejfgzp5e">简体中文</option><option value="/zh-tw/getting-started/" class="astro-ejfgzp5e">正體中文</option><option value="/fr/getting-started/" class="astro-ejfgzp5e">Français</option><option value="/hi/getting-started/" class="astro-ejfgzp5e">हिन्दी</option><option value="/ar/getting-started/" class="astro-ejfgzp5e">العربية</option><option value="/ja/getting-started/" class="astro-ejfgzp5e">日本語</option><option value="/ko/getting-started/" class="astro-ejfgzp5e">한국어</option><option value="/pl/getting-started/" class="astro-ejfgzp5e">Polski</option><option value="/ru/getting-started/" class="astro-ejfgzp5e">Русский</option><option value="/it/getting-started/" class="astro-ejfgzp5e">Italiano</option>
	</select>
...
<script type="module">class s extends HTMLElement{constructor(){super(),this.btn=this.querySelector("button"),this.btn.addEventListener("click",()=>this.toggleExpanded());const t=this.closest("nav");t&&t.addEventListener("keyup",e=>this.closeOnEscape(e))}setExpanded(t){this.setAttribute("aria-expanded",String(t)),document.body.toggleAttribute("data-mobile-menu-expanded",t)}toggleExpanded(){this.setExpanded(this.getAttribute("aria-expanded")!=="true")}closeOnEscape(t){t.code==="Escape"&&(this.setExpanded(!1),this.btn.focus())}}customElements.define("starlight-menu-button",s);</script>
 ...
 Third-party services
	...
	<li class="astro-aq2oaxcp">
				<a href="/en/getting-started/" aria-current="page" class="large astro-aq2oaxcp">
  ...
  <path d="M790.8 160.8h24.8V18.2h-24.8v142.6Zm-137-1.4a46.2 46.2 0 0 0 58.2-22c4-8 6-17 6-27s-2.1-19-6.2-27a45.2 45.2 0 0 0-42.3-25c-6 0-11.6 1-17 3.4a36.2 36.2 0 0 0-14.6 10.8V18.3h-25v142.5h24.9l-.1-13.3a42.6 42.6 0 0 0 16 11.9Zm25.5-23a27 27 0 0 1-14 3.7 27.4 27.4 0 0 1-24.5-14.5 31 31 0 0 1-3.7-15.3 31 31 0 0 1 3.7-15.3 27.3 27.3 0 0 1 24.5-14.3c5.3 0 9.9 1.2 14 3.7 4 2.4 7.2 5.9 9.4 10.4 2.3 4.5 3.4 9.7 3.4 15.5 0 5.8-1.1 11-3.4 15.5a25 25 0 0 1-9.4 10.6ZM324.6 26.8H353l25.4 92.8 27-92.8h23.7l29.3 91 24.4-91h26l-38.4 134H446L416.2 72l-27.4 88.8H364l-39.4-134Zm226.2 136.4a49.2 49.2 0 0 1-45.4-25.2c-4.5-8-6.8-17-6.8-27.2 0-10 2.4-18.9 7-26.9s10.8-14.2 18.7-18.7a52.4 52.4 0 0 1 26.4-6.8c11 0 20.5 2.5 28.7 7.3a45 45 0 0 1 18.5 20.7c4.1 8.8 5.6 19 4.4 30.5h-78c.3 4.5 1.4 8.7 3.5 12.4 2.3 4.2 5.5 7.4 9.6 9.7 4.2 2.3 8.8 3.4 13.9 3.4a29.2 29.2 0 0 0 19.3-7.3 20 20 0 0 0 5-7.7h26c-1.6 7-4.7 13.2-9.5 18.7a48.4 48.4 0 0 1-17.8 12.6c-7.2 3-15 4.6-23.5 4.5Zm-23-71.4a26.3 26.3 0 0 0-3 8.2h51.7a23.1 23.1 0 0 0-12.3-18.4c-3.8-2-8-3-12.8-3-5 0-9.6 1.2-13.7 3.5a25.7 25.7 0 0 0-9.8 9.7Zm208.5-31.3a42 42 0 0 1 5.5-21.6A38.2 38.2 0 0 1 757.4 24a51 51 0 0 1 23.5-5.5v22a22 22 0 0 0-10.7 2.7c-3 1.7-5.2 4-6.7 7.2a24 24 0 0 0-2.4 10.1h19.3v21h-19.3v79.3h-24.9V81.5h-16v-21h16ZM878.8 163a55.3 55.3 0 0 1-27.2-6.6 49.2 49.2 0 0 1-18.8-18.6 54 54 0 0 1-6.7-27c0-10.2 2.2-19.2 6.7-27.2A48 48 0 0 1 851.6 65c8-4.5 17-6.7 27.2-6.7s19.3 2.2 27.3 6.7c8 4.4 14.4 10.6 18.9 18.6a55 55 0 0 1 6.8 27.2c0 10-2.3 19-6.8 27a47.6 47.6 0 0 1-18.8 18.6 56 56 0 0 1-27.4 6.6Zm0-22.8c5.4 0 10-1.2 14.2-3.7a25 25 0 0 0 9.6-10.3 34 34 0 0 0 3.3-15.4c0-5.9-1-11-3.3-15.5s-5.5-8-9.6-10.4a27 27 0 0 0-14.2-3.7 25.2 25.2 0 0 0-23.6 14.1 33.4 33.4 0 0 0-3.2 15.5 34 34 0 0 0 3.3 15.4c2.3 4.4 5.5 7.8 9.5 10.3a26 26 0 0 0 14 3.7Zm79.8-79.7H931l30 100.3h24l19.7-64 21.3 64h23.9l30-100.3h-25l-17 62.5-18.9-62.5h-24.2L976 124.3l-17.5-63.8Z" />
	...
	<div id="_top" class="hero-content stack astro-w36gv4jc" style="--stack-gap: 2rem;">
		<div class="stack astro-w36gv4jc" style="--stack-gap: 1rem;">
			<h1 class="astro-w36gv4jc">Astro Docs</h1>
			<p class="astro-w36gv4jc">Guides, resources, and API references to help you build with Astro.</p>
		</div>
		<div class="sl-flex actions astro-w36gv4jc">
			<a class="sl-flex action primary astro-vnzlvqnm" href="/en/install-and-setup/">
	Install Astro
	
	<svg aria-hidden="true" class="astro-vnzlvqnm astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.5em;"><path fill-rule="evenodd" d="M1.44 8.855v-.001l3.527-3.516c.34-.344.802-.541 1.285-.548h6.649l.947-.947c3.07-3.07 6.207-3.072 7.62-2.868a1.821 1.821 0 0 1 1.557 1.557c.204 1.413.203 4.55-2.868 7.62l-.946.946v6.649a1.845 1.845 0 0 1-.549 1.286l-3.516 3.528a1.844 1.844 0 0 1-3.11-.944l-.858-4.275-4.52-4.52-2.31-.463-1.964-.394A1.847 1.847 0 0 1 .98 10.693a1.843 1.843 0 0 1 .46-1.838Zm5.379 2.017-3.873-.776L6.32 6.733h4.638l-4.14 4.14Zm8.403-5.655c2.459-2.46 4.856-2.463 5.89-2.33.134 1.035.13 3.432-2.329 5.891l-6.71 6.71-3.561-3.56 6.71-6.711Zm-1.318 15.837-.776-3.873 4.14-4.14v4.639l-3.364 3.374Z" clip-rule="evenodd"/><path d="M9.318 18.345a.972.972 0 0 0-1.86-.561c-.482 1.435-1.687 2.204-2.934 2.619a8.22 8.22 0 0 1-1.23.302c.062-.365.157-.79.303-1.229.415-1.247 1.184-2.452 2.62-2.935a.971.971 0 1 0-.62-1.842c-.12.04-.236.084-.35.13-2.02.828-3.012 2.588-3.493 4.033a10.383 10.383 0 0 0-.51 2.845l-.001.016v.063c0 .536.434.972.97.972H2.24a7.21 7.21 0 0 0 .878-.065c.527-.063 1.248-.19 2.02-.447 1.445-.48 3.205-1.472 4.033-3.494a5.828 5.828 0 0 0 .147-.407Z"/></svg>



	
</a><a class="sl-flex action minimal astro-vnzlvqnm" href="/en/concepts/why-astro/">
	Learn about Astro’s features
	
	<svg aria-hidden="true" class="astro-vnzlvqnm astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.5em;"><path d="M17.92 11.62a1.001 1.001 0 0 0-.21-.33l-5-5a1.003 1.003 0 1 0-1.42 1.42l3.3 3.29H7a1 1 0 0 0 0 2h7.59l-3.3 3.29a1.002 1.002 0 0 0 .325 1.639 1 1 0 0 0 1.095-.219l5-5a1 1 0 0 0 .21-.33 1 1 0 0 0 0-.76Z"/></svg>
	...
	<div class="mobile-only not-content astro-zmkmtucg">
	<p class="tagline astro-zmkmtucg">Powered by Astro and our open-source contributors. <a href="/en/contribute/" class="astro-zmkmtucg">Join us!</a></p>
</div>
<div class="facepile not-content astro-zmkmtucg">
	<div class="row astro-zmkmtucg">
					
					
<img src="/_astro/5098874_Xmneb.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg"><span class="circle astro-zmkmtucg"></span>
<img src="/_astro/61414485_Z1xsHVD.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/357379_ZKO92b.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					<span class="circle astro-zmkmtucg"></span>
<img src="/_astro/361671_1jGyyS.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/7118177_ZpfedT.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/602478_Z1j0biA.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/3019731_Z1d2OlH.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					
<img src="/_astro/85648028_ZS2tmy.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/34116392_ZbAa2A.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg"><span class="circle astro-zmkmtucg"></span>
<img src="/_astro/39112954_2r9kRD.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					
<img src="/_astro/108291165_Z1suPGD.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg"><span class="astro-zmkmtucg"></span>
<img src="/_astro/622227_ZgWgJ2.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg"><span class="circle astro-zmkmtucg"></span>
<img src="/_astro/494699_Uj3X8.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					
<img src="/_astro/69633530_2iImQL.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/59021693_ZHbveW.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/25167721_FdCXa.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/1369770_8D3ud.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/15836226_ZtVxk8.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/213306_18n3Wi.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					
<img src="/_astro/51384119_c1LGe.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/14293805_1joHXY.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg"><span class="circle astro-zmkmtucg"></span>
<img src="/_astro/15368_buQwa.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/78129249_2j195u.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					
<img src="/_astro/10626596_2bKcQK.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/7889778_2mvI3m.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/2740_Z1I0gm6.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/15145918_Z1i4sKD.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/30520689_ZJkafL.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/64310361_Z2cKvpc.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					<p class="tagline astro-zmkmtucg">
							Powered by Astro and our open-source contributors. <a href="/en/contribute/" class="astro-zmkmtucg">Join us!</a>
						</p>
					
<img src="/_astro/188426_1SeoP1.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/99918022_ZzxxyP.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/46791833_Z1KNVzb.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div><div class="row astro-zmkmtucg">
					
					
<img src="/_astro/69170106_1JOJsJ.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/45965090_Z1Q0PLL.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/36526527_ZGtduA.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg"><span class="circle astro-zmkmtucg"></span>
				</div><div class="row astro-zmkmtucg">
					
					<span class="astro-zmkmtucg"></span>
<img src="/_astro/15368_buQwa.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/4033662_gFxik.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
<img src="/_astro/25839948_s92Cr.webp" loading="eager" alt decoding="async" fetchpriority="auto" width="84" height="84" class="astro-zmkmtucg">
				</div>
</div>
</div>
								<div class="sl-markdown-content">
	
									<div class="card-grid astro-jfzlr66e"><div class="landing-card astro-thryqltm">
	<article class="card sl-flex astro-eayepz6j">
	<p class="title sl-flex astro-eayepz6j">
		
	<svg aria-hidden="true" class="icon astro-eayepz6j astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.333em;"><path d="M21 14h-1V7a3 3 0 0 0-3-3H7a3 3 0 0 0-3 3v7H3a1 1 0 0 0-1 1v2a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3v-2a1 1 0 0 0-1-1ZM6 7a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v7H6V7Zm14 10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-1h16v1Z"/></svg>



		<span class="astro-eayepz6j">What will you build with Astro?</span>
	</p>
	<div class="body astro-eayepz6j"><p>Explore <a href="https://astro.build/themes/">Astro starter themes</a> for blogs, portfolios, docs, landing pages, SaaS, marketing, ecommerce sites, and more!</p></div>
</article>
</div><div class="landing-card astro-thryqltm">
	<article class="card sl-flex astro-eayepz6j">
	<p class="title sl-flex astro-eayepz6j">
	...
	<svg aria-hidden="true" class="icon astro-eayepz6j astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.333em;"><path d="M22 9.67a1 1 0 0 0-.86-.67l-5.69-.83L12.9 3a1 1 0 0 0-1.8 0L8.55 8.16 2.86 9a1 1 0 0 0-.81.68 1 1 0 0 0 .25 1l4.13 4-1 5.68a1 1 0 0 0 1.45 1.07L12 18.76l5.1 2.68c.14.08.3.12.46.12a1 1 0 0 0 .99-1.19l-1-5.68 4.13-4A1 1 0 0 0 22 9.67Zm-6.15 4a1 1 0 0 0-.29.89l.72 4.19-3.76-2a1 1 0 0 0-.94 0l-3.76 2 .72-4.19a1 1 0 0 0-.29-.89l-3-3 4.21-.61a1 1 0 0 0 .76-.55L12 5.7l1.88 3.82a1 1 0 0 0 .76.55l4.21.61-3 2.99Z"/></svg>
		...
		<span class="astro-eayepz6j">Take a guided tour</span>
	</p>
	<div class="body astro-eayepz6j"><p>Complete our introductory <a href="/en/tutorial/0-introduction/">Build a Blog Tutorial</a> to learn the basics and create your first Astro site.</p></div>
</article>
</div><div class="card--fullwidth astro-5ohpsof5">
	<article class="card sl-flex astro-eayepz6j">
	<p class="title sl-flex astro-eayepz6j">
	...
	<svg aria-hidden="true" class="icon astro-eayepz6j astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.333em;"><path fill-rule="evenodd" d="M1.44 8.855v-.001l3.527-3.516c.34-.344.802-.541 1.285-.548h6.649l.947-.947c3.07-3.07 6.207-3.072 7.62-2.868a1.821 1.821 0 0 1 1.557 1.557c.204 1.413.203 4.55-2.868 7.62l-.946.946v6.649a1.845 1.845 0 0 1-.549 1.286l-3.516 3.528a1.844 1.844 0 0 1-3.11-.944l-.858-4.275-4.52-4.52-2.31-.463-1.964-.394A1.847 1.847 0 0 1 .98 10.693a1.843 1.843 0 0 1 .46-1.838Zm5.379 2.017-3.873-.776L6.32 6.733h4.638l-4.14 4.14Zm8.403-5.655c2.459-2.46 4.856-2.463 5.89-2.33.134 1.035.13 3.432-2.329 5.891l-6.71 6.71-3.561-3.56 6.71-6.711Zm-1.318 15.837-.776-3.873 4.14-4.14v4.639l-3.364 3.374Z" clip-rule="evenodd"/><path d="M9.318 18.345a.972.972 0 0 0-1.86-.561c-.482 1.435-1.687 2.204-2.934 2.619a8.22 8.22 0 0 1-1.23.302c.062-.365.157-.79.303-1.229.415-1.247 1.184-2.452 2.62-2.935a.971.971 0 1 0-.62-1.842c-.12.04-.236.084-.35.13-2.02.828-3.012 2.588-3.493 4.033a10.383 10.383 0 0 0-.51 2.845l-.001.016v.063c0 .536.434.972.97.972H2.24a7.21 7.21 0 0 0 .878-.065c.527-.063 1.248-.19 2.02-.447 1.445-.48 3.205-1.472 4.033-3.494a5.828 5.828 0 0 0 .147-.407Z"/></svg>
		...
		<span class="astro-eayepz6j">Start a new project</span>
	</p>
	<div class="body astro-eayepz6j">
	...
	<svg aria-hidden="true" class="icon astro-eayepz6j astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.333em;"><path d="M21.17 2.06A13.1 13.1 0 0 0 19 1.87a12.94 12.94 0 0 0-7 2.05 12.94 12.94 0 0 0-7-2 13.1 13.1 0 0 0-2.17.19 1 1 0 0 0-.83 1v12a1 1 0 0 0 1.17 1 10.9 10.9 0 0 1 8.25 1.91l.12.07h.11a.91.91 0 0 0 .7 0h.11l.12-.07A10.899 10.899 0 0 1 20.83 16 1 1 0 0 0 22 15V3a1 1 0 0 0-.83-.94ZM11 15.35a12.87 12.87 0 0 0-6-1.48H4v-10c.333-.02.667-.02 1 0a10.86 10.86 0 0 1 6 1.8v9.68Zm9-1.44h-1a12.87 12.87 0 0 0-6 1.48V5.67a10.86 10.86 0 0 1 6-1.8c.333-.02.667-.02 1 0v10.04Zm1.17 4.15a13.098 13.098 0 0 0-2.17-.19 12.94 12.94 0 0 0-7 2.05 12.94 12.94 0 0 0-7-2.05c-.727.003-1.453.066-2.17.19A1 1 0 0 0 2 19.21a1 1 0 0 0 1.17.79 10.9 10.9 0 0 1 8.25 1.91 1 1 0 0 0 1.16 0A10.9 10.9 0 0 1 20.83 20a1 1 0 0 0 1.17-.79 1 1 0 0 0-.83-1.15Z"/></svg>
		...
		<span class="astro-eayepz6j">Learn</span>
	</p>
	<div class="body astro-eayepz6j">
	<div class="link-list astro-nsjz63yc">
		<ul>
...
<li><a href="/en/reference/astro-syntax/">The Astro template syntax</a></li>
	...
	<svg aria-hidden="true" class="icon astro-eayepz6j astro-lbujlyan" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style="--sl-icon-size: 1.333em;"><path d="M17 22H5a3 3 0 0 1-3-3V9a3 3 0 0 1 3-3h1a4 4 0 0 1 7.3-2.18c.448.64.692 1.4.7 2.18h3a1 1 0 0 1 1 1v3a4 4 0 0 1 2.18 7.3A3.86 3.86 0 0 1 18 18v3a1 1 0 0 1-1 1ZM5 8a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h11v-3.18a1 1 0 0 1 1.33-.95 1.77 1.77 0 0 0 1.74-.23 2 2 0 0 0 .93-1.37 2 2 0 0 0-.48-1.59 1.89 1.89 0 0 0-2.17-.55 1 1 0 0 1-1.33-.95V8h-3.2a1 1 0 0 1-1-1.33 1.77 1.77 0 0 0-.23-1.74 1.939 1.939 0 0 0-3-.43A2 2 0 0 0 8 6c.002.23.046.456.13.67A1 1 0 0 1 7.18 8H5Z"/></svg>
		...
		<span class="astro-eayepz6j">Extend</span>
	</p>
	<div class="body astro-eayepz6j">
	<div class="link-list astro-nsjz63yc">
		<ul>
...
<div class="discord astro-db2gborc">
	<h2 class="astro-db2gborc">Have a question or want to get involved?</h2>
	<div class="cta astro-db2gborc">
		
<img src="/_astro/houston_love.BttrNCcZ_Ok6Ar.webp" alt loading="lazy" decoding="async" fetchpriority="auto" width="292" height="293" class="hide astro-db2gborc">
		<a class="sl-flex action secondary astro-vnzlvqnm" href="https://astro.build/chat">
	Join our Discord
