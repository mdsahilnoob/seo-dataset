...
<li id="pt-login-2" class="user-links-collapsible-item mw-list-item user-links-collapsible-item"><a data-mw-interface  href="/w/index.php?title=Special:UserLogin&amp;returnto=JavaScript" title="You&#039;re encouraged to log in; however, it&#039;s not mandatory. [o]" accesskey="o" class=""><span>Log in</span></a>
</li>
...
>
	...
	<ul class="vector-toc-contents" id="mw-panel-toc-list">
		...
		<ul id="toc-History-sublist" class="vector-toc-list">
			<li id="toc-Creation_at_Netscape"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Creation_at_Netscape">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">1.1</span>
					<span>Creation at Netscape</span>
				</div>
			</a>
			
			<ul id="toc-Creation_at_Netscape-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Adoption_by_Microsoft"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Adoption_by_Microsoft">
				<div class="vector-toc-text">
			...
			<ul id="toc-Adoption_by_Microsoft-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-The_rise_of_JScript"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#The_rise_of_JScript">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">1.3</span>
					<span>The rise of JScript</span>
				</div>
			</a>
			
			<ul id="toc-The_rise_of_JScript-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Growth_and_standardization"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Growth_and_standardization">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">1.4</span>
					<span>Growth and standardization</span>
				</div>
			</a>
			
			<ul id="toc-Growth_and_standardization-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Reaching_maturity"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Reaching_maturity">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">1.5</span>
					<span>Reaching maturity</span>
				</div>
			</a>
			
			<ul id="toc-Reaching_maturity-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
	</li>
	<li id="toc-Trademark"
		class="vector-toc-list-item vector-toc-level-1">
		<a class="vector-toc-link" href="#Trademark">
			<div class="vector-toc-text">
		...
		<ul id="toc-Trademark-sublist" class="vector-toc-list">
		</ul>
	</li>
	<li id="toc-Website_client-side_usage"
		class="vector-toc-list-item vector-toc-level-1">
		<a class="vector-toc-link" href="#Website_client-side_usage">
			<div class="vector-toc-text">
				<span class="vector-toc-numb">3</span>
				<span>Website client-side usage</span>
			</div>
		</a>
		
			<button aria-controls="toc-Website_client-side_usage-sublist" class="cdx-button cdx-button--weight-quiet cdx-button--icon-only vector-toc-toggle">
				<span class="vector-icon mw-ui-icon-wikimedia-expand"></span>
				<span>Toggle Website client-side usage subsection</span>
			</button>
		
		<ul id="toc-Website_client-side_usage-sublist" class="vector-toc-list">
			<li id="toc-Examples_of_scripted_behavior"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Examples_of_scripted_behavior">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">3.1</span>
					<span>Examples of scripted behavior</span>
				</div>
			</a>
			
			<ul id="toc-Examples_of_scripted_behavior-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Libraries_and_frameworks"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Libraries_and_frameworks">
				<div class="vector-toc-text">
			...
			<ul id="toc-Libraries_and_frameworks-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
	</li>
	<li id="toc-Other_usage"
		class="vector-toc-list-item vector-toc-level-1">
		<a class="vector-toc-link" href="#Other_usage">
			<div class="vector-toc-text">
		...
		<ul id="toc-Other_usage-sublist" class="vector-toc-list">
		</ul>
	</li>
	<li id="toc-Execution"
		class="vector-toc-list-item vector-toc-level-1">
		<a class="vector-toc-link" href="#Execution">
			...
			<button aria-controls="toc-Execution-sublist" class="cdx-button cdx-button--weight-quiet cdx-button--icon-only vector-toc-toggle">
				<span class="vector-icon mw-ui-icon-wikimedia-expand"></span>
				<span>Toggle Execution subsection</span>
			</button>
		
		<ul id="toc-Execution-sublist" class="vector-toc-list">
			<li id="toc-JavaScript_engine"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#JavaScript_engine">
				<div class="vector-toc-text">
			...
			<ul id="toc-JavaScript_engine-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Runtime_system"
			class="vector-toc-list-item vector-toc-level-2">
			...
			<ul id="toc-Runtime_system-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
	</li>
	<li id="toc-Features"
		...
		<ul id="toc-Features-sublist" class="vector-toc-list">
			<li id="toc-Imperative_and_structured"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Imperative_and_structured">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.1</span>
					<span>Imperative and structured</span>
				</div>
			</a>
			
			<ul id="toc-Imperative_and_structured-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Weakly_typed"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Weakly_typed">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.2</span>
					<span>Weakly typed</span>
				</div>
			</a>
			
			<ul id="toc-Weakly_typed-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Dynamic"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Dynamic">
				<div class="vector-toc-text">
			...
			<ul id="toc-Dynamic-sublist" class="vector-toc-list">
				<li id="toc-Typing"
		...
		<li id="toc-Run-time_evaluation"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Run-time_evaluation">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.3.2</span>
					<span>Run-time evaluation</span>
				</div>
			</a>
			
			<ul id="toc-Run-time_evaluation-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
		</li>
		<li id="toc-Object-orientation_(prototype-based)"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Object-orientation_(prototype-based)">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.4</span>
					<span>Object-orientation (prototype-based)</span>
				</div>
			</a>
			
			<ul id="toc-Object-orientation_(prototype-based)-sublist" class="vector-toc-list">
				<li id="toc-Prototypes"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Prototypes">
				<div class="vector-toc-text">
			...
			<ul id="toc-Prototypes-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Functions_as_object_constructors"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Functions_as_object_constructors">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.4.2</span>
					<span>Functions as object constructors</span>
				</div>
			</a>
			
			<ul id="toc-Functions_as_object_constructors-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Functions_as_methods"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Functions_as_methods">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.4.3</span>
					<span>Functions as methods</span>
				</div>
			</a>
			
			<ul id="toc-Functions_as_methods-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
		</li>
		<li id="toc-Functional"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Functional">
				<div class="vector-toc-text">
			...
			<ul id="toc-Functional-sublist" class="vector-toc-list">
				<li id="toc-Lexical_closure"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Lexical_closure">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.5.1</span>
					<span>Lexical closure</span>
				</div>
			</a>
			
			<ul id="toc-Lexical_closure-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Anonymous_function"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Anonymous_function">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.5.2</span>
					<span>Anonymous function</span>
				</div>
			</a>
			
			<ul id="toc-Anonymous_function-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
		</li>
		<li id="toc-Delegative"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Delegative">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.6</span>
					<span>Delegative</span>
				</div>
			</a>
			
			<ul id="toc-Delegative-sublist" class="vector-toc-list">
				<li id="toc-Functions_as_roles_(Traits_and_Mixins)"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Functions_as_roles_(Traits_and_Mixins)">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.6.1</span>
					<span>Functions as roles (Traits and Mixins)</span>
				</div>
			</a>
			
			<ul id="toc-Functions_as_roles_(Traits_and_Mixins)-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Object_composition_and_inheritance"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Object_composition_and_inheritance">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.6.2</span>
					<span>Object composition and inheritance</span>
				</div>
			</a>
			
			<ul id="toc-Object_composition_and_inheritance-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
		</li>
		<li id="toc-Miscellaneous"
			...
			<ul id="toc-Miscellaneous-sublist" class="vector-toc-list">
				<li id="toc-Zero-based_numbering"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Zero-based_numbering">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.7.1</span>
					<span>Zero-based numbering</span>
				</div>
			</a>
			
			<ul id="toc-Zero-based_numbering-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Variadic_functions"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Variadic_functions">
				<div class="vector-toc-text">
			...
			<ul id="toc-Variadic_functions-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Array_and_object_literals"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Array_and_object_literals">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.7.3</span>
					<span>Array and object literals</span>
				</div>
			</a>
			
			<ul id="toc-Array_and_object_literals-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Regular_expressions"
			class="vector-toc-list-item vector-toc-level-3">
			<a class="vector-toc-link" href="#Regular_expressions">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.7.4</span>
					<span>Regular expressions</span>
				</div>
			</a>
			
			<ul id="toc-Regular_expressions-sublist" class="vector-toc-list">
				<li id="toc-Promises"
			class="vector-toc-list-item vector-toc-level-4">
			<a class="vector-toc-link" href="#Promises">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.7.4.1</span>
					<span>Promises</span>
				</div>
			</a>
			
			<ul id="toc-Promises-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Async/await"
			class="vector-toc-list-item vector-toc-level-4">
			<a class="vector-toc-link" href="#Async/await">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.7.4.2</span>
					<span>Async/await</span>
				</div>
			</a>
			
			<ul id="toc-Async/await-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
		</li>
		...
		<li id="toc-Vendor-specific_extensions"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Vendor-specific_extensions">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">6.8</span>
					<span>Vendor-specific extensions</span>
				</div>
			</a>
			
			<ul id="toc-Vendor-specific_extensions-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
	</li>
	...
	<li id="toc-Security"
		...
		<ul id="toc-Security-sublist" class="vector-toc-list">
			<li id="toc-Cross-site_scripting"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Cross-site_scripting">
				<div class="vector-toc-text">
			...
			<ul id="toc-Cross-site_scripting-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Cross-site_request_forgery"
			class="vector-toc-list-item vector-toc-level-2">
			...
			<ul id="toc-Cross-site_request_forgery-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Misplaced_trust_in_the_client"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Misplaced_trust_in_the_client">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">8.3</span>
					<span>Misplaced trust in the client</span>
				</div>
			</a>
			
			<ul id="toc-Misplaced_trust_in_the_client-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Misplaced_trust_in_developers"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Misplaced_trust_in_developers">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">8.4</span>
					<span>Misplaced trust in developers</span>
				</div>
			</a>
			
			<ul id="toc-Misplaced_trust_in_developers-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Browser_and_plugin_coding_errors"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Browser_and_plugin_coding_errors">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">8.5</span>
					<span>Browser and plugin coding errors</span>
				</div>
			</a>
			
			<ul id="toc-Browser_and_plugin_coding_errors-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Sandbox_implementation_errors"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Sandbox_implementation_errors">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">8.6</span>
					<span>Sandbox implementation errors</span>
				</div>
			</a>
			
			<ul id="toc-Sandbox_implementation_errors-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Hardware_vulnerabilities"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Hardware_vulnerabilities">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">8.7</span>
					<span>Hardware vulnerabilities</span>
				</div>
			</a>
			
			<ul id="toc-Hardware_vulnerabilities-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
	</li>
	<li id="toc-Development_tools"
		class="vector-toc-list-item vector-toc-level-1">
		<a class="vector-toc-link" href="#Development_tools">
			<div class="vector-toc-text">
		...
		<ul id="toc-Development_tools-sublist" class="vector-toc-list">
		</ul>
	</li>
	<li id="toc-Related_technologies"
		class="vector-toc-list-item vector-toc-level-1">
		<a class="vector-toc-link" href="#Related_technologies">
			<div class="vector-toc-text">
			...
			<button aria-controls="toc-Related_technologies-sublist" class="cdx-button cdx-button--weight-quiet cdx-button--icon-only vector-toc-toggle">
				<span class="vector-icon mw-ui-icon-wikimedia-expand"></span>
				<span>Toggle Related technologies subsection</span>
			</button>
		
		<ul id="toc-Related_technologies-sublist" class="vector-toc-list">
			<li id="toc-Java"
			class="vector-toc-list-item vector-toc-level-2">
		...
		<li id="toc-JSON"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#JSON">
				<div class="vector-toc-text">
			...
			<ul id="toc-JSON-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-Transpilers"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#Transpilers">
				<div class="vector-toc-text">
					<span class="vector-toc-numb">10.3</span>
					<span>Transpilers</span>
				</div>
			</a>
			
			<ul id="toc-Transpilers-sublist" class="vector-toc-list">
			</ul>
		</li>
		<li id="toc-WebAssembly"
			class="vector-toc-list-item vector-toc-level-2">
			<a class="vector-toc-link" href="#WebAssembly">
				<div class="vector-toc-text">
			...
			<ul id="toc-WebAssembly-sublist" class="vector-toc-list">
			</ul>
		</li>
	</ul>
	</li>
...
<div id="p-lang-btn" class="vector-dropdown mw-portlet mw-portlet-lang"  >
	<input type="checkbox" id="p-lang-btn-checkbox" role="button" aria-haspopup="true" data-event-name="ui.dropdown-p-lang-btn" class="vector-dropdown-checkbox mw-interlanguage-selector" aria-label="Go to an article in another language. Available in 115 languages"   >
	<label id="p-lang-btn-label" for="p-lang-btn-checkbox" class="vector-dropdown-label cdx-button cdx-button--fake-button cdx-button--fake-button--enabled cdx-button--weight-quiet cdx-button--action-progressive mw-portlet-lang-heading-115" aria-hidden="true"  ><span class="vector-icon mw-ui-icon-language-progressive mw-ui-icon-wikimedia-language-progressive"></span>

<span class="vector-dropdown-label-text">115 languages</span>
	</label>
	<div class="vector-dropdown-content">
...
<div id="p-views" class="vector-menu vector-menu-tabs mw-portlet mw-portlet-views"  >
	<div class="vector-menu-content">
		...
		<ul class="vector-menu-content-list">
			...
			<li id="ca-view" class="selected vector-tab-noicon mw-list-item"><a href="/wiki/JavaScript"><span>Read</span></a></li><li id="ca-viewsource" class="vector-tab-noicon mw-list-item"><a href="/w/index.php?title=JavaScript&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e"><span>View source</span></a></li><li id="ca-history" class="vector-tab-noicon mw-list-item"><a href="/w/index.php?title=JavaScript&amp;action=history" title="Past revisions of this page [h]" accesskey="h"><span>View history</span></a></li>
		</ul>
...
<div id="p-tb" class="vector-menu mw-portlet mw-portlet-tb"  >
	...
	<div class="vector-menu-content">
		...
		<ul class="vector-menu-content-list">
			...
			<li id="t-whatlinkshere" class="mw-list-item"><a href="/wiki/Special:WhatLinksHere/JavaScript" title="List of all English Wikipedia pages containing links to this page [j]" accesskey="j"><span>What links here</span></a></li><li id="t-recentchangeslinked" class="mw-list-item"><a href="/wiki/Special:RecentChangesLinked/JavaScript" rel="nofollow" title="Recent changes in pages linked from this page [k]" accesskey="k"><span>Related changes</span></a></li><li id="t-upload" class="mw-list-item"><a href="//en.wikipedia.org/wiki/Wikipedia:File_Upload_Wizard" title="Upload files [u]" accesskey="u"><span>Upload file</span></a></li><li id="t-permalink" class="mw-list-item"><a href="/w/index.php?title=JavaScript&amp;oldid=1330436866" title="Permanent link to this revision of this page"><span>Permanent link</span></a></li><li id="t-info" class="mw-list-item"><a href="/w/index.php?title=JavaScript&amp;action=info" title="More information about this page"><span>Page information</span></a></li><li id="t-cite" class="mw-list-item"><a href="/w/index.php?title=Special:CiteThisPage&amp;page=JavaScript&amp;id=1330436866&amp;wpFormIdentifier=titleform" title="Information on how to cite this page"><span>Cite this page</span></a></li><li id="t-urlshortener" class="mw-list-item"><a href="/w/index.php?title=Special:UrlShortener&amp;url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FJavaScript"><span>Get shortened URL</span></a></li><li id="t-urlshortener-qrcode" class="mw-list-item"><a href="/w/index.php?title=Special:QrCode&amp;url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FJavaScript"><span>Download QR code</span></a></li>
		</ul>
...
</div><div class="mw-content-ltr mw-parser-output" lang="en" dir="ltr"><div class="shortdescription nomobile noexcerpt noprint searchaux" style="display:none">High-level programming language</div>
...
</p><p>Although <a href="/wiki/Java_(programming_language)" title="Java (programming language)">Java</a> and JavaScript are similar in name and <a href="/wiki/Syntax_(programming_languages)" title="Syntax (programming languages)">syntax</a>, the two languages are distinct and differ greatly in design.
</p>
<meta property="mw:PageProp/toc" />
<div class="mw-heading mw-heading2"><h2 id="History">History</h2></div>
<div class="mw-heading mw-heading3"><h3 id="Creation_at_Netscape">Creation at Netscape</h3></div>
<p>The first popular <a href="/wiki/Web_browser" title="Web browser">web browser</a> with a <a href="/wiki/Graphical_user_interface" title="Graphical user interface">graphical user interface</a>, <a href="/wiki/Mosaic_(web_browser)" class="mw-redirect" title="Mosaic (web browser)">Mosaic</a>, was released in 1993. The lead developers of Mosaic then founded the <a href="/wiki/Netscape" title="Netscape">Netscape</a> corporation, which released a more polished browser, <a href="/wiki/Netscape_Navigator" title="Netscape Navigator">Netscape Navigator</a>, in 1994. This quickly became the most-used.<sup id="cite&#95;ref-14" class="reference"><a href="#cite_note-14"><span class="cite-bracket">&#91;</span>13<span class="cite-bracket">&#93;</span></a></sup>
</p><p>During these formative years of the Web, <a href="/wiki/Web_page" title="Web page">web pages</a> could only be static, lacking the capability for dynamic behavior after the page was loaded in the browser. There was a desire in the flourishing web development scene to remove this limitation, so in 1995, Netscape decided to add a <a href="/wiki/Programming_language" title="Programming language">programming language</a> to Navigator. They pursued two routes to achieve this: collaborating with <a href="/wiki/Sun_Microsystems" title="Sun Microsystems">Sun Microsystems</a> to embed the <a href="/wiki/Java_(programming_language)" title="Java (programming language)">Java</a> language, while also hiring <a href="/wiki/Brendan_Eich" title="Brendan Eich">Brendan Eich</a> to embed the <a href="/wiki/Scheme_(programming_language)" title="Scheme (programming language)">Scheme</a> language.<sup id="cite&#95;ref-origin&#95;6-3" class="reference"><a href="#cite_note-origin-6"><span class="cite-bracket">&#91;</span>6<span class="cite-bracket">&#93;</span></a></sup>
</p><p>The goal was a "language for the masses",<sup id="cite&#95;ref-EichVideo&#95;15-0" class="reference"><a href="#cite_note-EichVideo-15"><span class="cite-bracket">&#91;</span>14<span class="cite-bracket">&#93;</span></a></sup> "to help nonprogrammers create dynamic, interactive <a href="/wiki/Website" title="Website">Web sites</a>".<sup id="cite&#95;ref-16" class="reference"><a href="#cite_note-16"><span class="cite-bracket">&#91;</span>15<span class="cite-bracket">&#93;</span></a></sup> Netscape management soon decided that the best option was for Eich to devise a new language, with syntax similar to Java and less like Scheme or other extant <a href="/wiki/Scripting_language" title="Scripting language">scripting languages</a>.<sup id="cite&#95;ref-looklikejava&#95;5-1" class="reference"><a href="#cite_note-looklikejava-5"><span class="cite-bracket">&#91;</span>5<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-origin&#95;6-4" class="reference"><a href="#cite_note-origin-6"><span class="cite-bracket">&#91;</span>6<span class="cite-bracket">&#93;</span></a></sup> Although the new language and its <a href="/wiki/Interpreter_(computing)" title="Interpreter (computing)">interpreter</a> implementation were called LiveScript when first shipped as part of a Navigator <a href="/wiki/Beta_software" class="mw-redirect" title="Beta software">beta</a> in September 1995, the name was changed to JavaScript for the official release in December.<sup id="cite&#95;ref-origin&#95;6-5" class="reference"><a href="#cite_note-origin-6"><span class="cite-bracket">&#91;</span>6<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-press&#95;release&#95;1-1" class="reference"><a href="#cite_note-press_release-1"><span class="cite-bracket">&#91;</span>1<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-techvision&#95;17-0" class="reference"><a href="#cite_note-techvision-17"><span class="cite-bracket">&#91;</span>16<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-wired2024&#95;18-0" class="reference"><a href="#cite_note-wired2024-18"><span class="cite-bracket">&#91;</span>17<span class="cite-bracket">&#93;</span></a></sup>
</p><p>The choice of the <i>JavaScript</i> name has caused confusion, implying that it is directly related to Java. At the time, the <a href="/wiki/Dot-com_bubble" title="Dot-com bubble">dot-com boom</a> had begun and Java was a popular new language, so Eich considered the JavaScript name a marketing ploy by Netscape.<sup id="cite&#95;ref-EichVideo&#95;15-1" class="reference"><a href="#cite_note-EichVideo-15"><span class="cite-bracket">&#91;</span>14<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading3"><h3 id="Adoption_by_Microsoft">Adoption by Microsoft</h3></div>
<p><a href="/wiki/Microsoft" title="Microsoft">Microsoft</a> debuted <a href="/wiki/Internet_Explorer" title="Internet Explorer">Internet Explorer</a> in 1995, leading to a <a href="/wiki/Browser_war" class="mw-redirect" title="Browser war">browser war</a> with Netscape. On the JavaScript front, Microsoft created its own <a href="/wiki/Interpreter_(computing)" title="Interpreter (computing)">interpreter</a> called <a href="/wiki/JScript" title="JScript">JScript</a>.<sup id="cite&#95;ref-sjsch5&#95;19-0" class="reference"><a href="#cite_note-sjsch5-19"><span class="cite-bracket">&#91;</span>18<span class="cite-bracket">&#93;</span></a></sup>
</p><p>Microsoft first released JScript in 1996, alongside initial support for <a href="/wiki/CSS" title="CSS">CSS</a> and extensions to <a href="/wiki/HTML" title="HTML">HTML</a>. Each of these <a href="/wiki/Implementation" title="Implementation">implementations</a> was noticeably different from their counterparts in <a href="/wiki/Netscape_Navigator" title="Netscape Navigator">Netscape Navigator</a>.<sup id="cite&#95;ref-O&#39;Reilly-2001&#95;20-0" class="reference"><a href="#cite_note-O&#39;Reilly-2001-20"><span class="cite-bracket">&#91;</span>19<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-21" class="reference"><a href="#cite_note-21"><span class="cite-bracket">&#91;</span>20<span class="cite-bracket">&#93;</span></a></sup> These differences made it difficult for developers to make their websites work well in both browsers, leading to widespread use of "best viewed in Netscape" and "best viewed in Internet Explorer" logos for several years.<sup id="cite&#95;ref-O&#39;Reilly-2001&#95;20-1" class="reference"><a href="#cite_note-O&#39;Reilly-2001-20"><span class="cite-bracket">&#91;</span>19<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-22" class="reference"><a href="#cite_note-22"><span class="cite-bracket">&#91;</span>21<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading3"><h3 id="The_rise_of_JScript">The rise of JScript</h3></div>
...
</p><p>The standards process continued for a few years, with the release of ECMAScript 2 in June 1998 and ECMAScript 3 in December 1999. Work on ECMAScript 4 began in 2000.<sup id="cite&#95;ref-sjsch5&#95;19-1" class="reference"><a href="#cite_note-sjsch5-19"><span class="cite-bracket">&#91;</span>18<span class="cite-bracket">&#93;</span></a></sup>
</p><p>However, the effort to fully standardize the language was undermined by Microsoft gaining an increasingly dominant position in the browser market. By the early 2000s, <a href="/wiki/Internet_Explorer" title="Internet Explorer">Internet Explorer</a>'s market share reached 95%.<sup id="cite&#95;ref-searchenginejournal.com&#95;23-0" class="reference"><a href="#cite_note-searchenginejournal.com-23"><span class="cite-bracket">&#91;</span>22<span class="cite-bracket">&#93;</span></a></sup> This meant that <a href="/wiki/JScript" title="JScript">JScript</a> became the de facto standard for <a href="/wiki/Client-side_scripting" class="mw-redirect" title="Client-side scripting">client-side scripting</a> on the Web.
...
<div class="mw-heading mw-heading3"><h3 id="Growth_and_standardization">Growth and standardization</h3></div>
...
<span typeof="mw:File/Frameless"><a href="/wiki/File:Logo_of_TC39.svg" class="mw-file-description" title="Logo of Ecma International Technical Committee 39 who is responsible for maintaining the standard"><img alt="Logo of Ecma International Technical Committee 39 who is responsible for maintaining the standard" src="//upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Logo_of_TC39.svg/250px-Logo_of_TC39.svg.png" decoding="async" width="150" height="150" class="mw-file-element" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Logo_of_TC39.svg/330px-Logo_of_TC39.svg.png 2x" data-file-width="512" data-file-height="512" /></a></span><div class="thumbcaption" style="display:table-caption;caption-side:bottom;box-sizing:border-box;">Logo of <a href="/wiki/Ecma_International" title="Ecma International">Ecma International</a> Technical Committee 39 who is responsible for maintaining the standard </div>
</div>
</div>
<p>During the period of <a href="/wiki/Internet_Explorer" title="Internet Explorer">Internet Explorer</a> dominance in the early 2000s, client-side scripting was stagnant. This started to change in 2004, when the successor of Netscape, <a href="/wiki/Mozilla" title="Mozilla">Mozilla</a>, released the <a href="/wiki/Firefox" title="Firefox">Firefox</a> browser. Firefox was well received by many, taking significant market share from Internet Explorer.<sup id="cite&#95;ref-24" class="reference"><a href="#cite_note-24"><span class="cite-bracket">&#91;</span>23<span class="cite-bracket">&#93;</span></a></sup>
</p><p>In 2005, Mozilla joined ECMA International, and work started on the <a href="/wiki/ECMAScript_for_XML" title="ECMAScript for XML">ECMAScript for XML</a> (E4X) standard. This led to Mozilla working jointly with <a href="/wiki/Macromedia" title="Macromedia">Macromedia</a> (later acquired by <a href="/wiki/Adobe_Systems" class="mw-redirect" title="Adobe Systems">Adobe Systems</a>), who were implementing E4X in their ActionScript 3 language, which was based on an ECMAScript 4 draft. The goal became standardizing ActionScript 3 as the new ECMAScript 4. To this end, Adobe Systems released the <a href="/wiki/Tamarin_(software)" title="Tamarin (software)">Tamarin</a> implementation as an <a href="/wiki/Open-source_model" class="mw-redirect" title="Open-source model">open source</a> project. However, Tamarin and ActionScript 3 were too different from established client-side scripting, and without cooperation from Microsoft, ECMAScript 4 never reached fruition.
</p><p>Meanwhile, very important developments were occurring in open-source communities not affiliated with ECMA work. In 2005, <a href="/wiki/Jesse_James_Garrett" title="Jesse James Garrett">Jesse James Garrett</a> released a white paper in which he coined the term <a href="/wiki/Ajax_(programming)" title="Ajax (programming)">Ajax</a> and described a set of technologies, of which JavaScript was the backbone, to create <a href="/wiki/Web_application" title="Web application">web applications</a> where data can be loaded in the background, avoiding the need for full page reloads. This sparked a renaissance period of JavaScript, spearheaded by open-source libraries and the communities that formed around them. Many new libraries were created, including <a href="/wiki/JQuery" title="JQuery">jQuery</a>, <a href="/wiki/Prototype_JavaScript_Framework" title="Prototype JavaScript Framework">Prototype</a>, <a href="/wiki/Dojo_Toolkit" class="mw-redirect" title="Dojo Toolkit">Dojo Toolkit</a>, and <a href="/wiki/MooTools" title="MooTools">MooTools</a>.
</p><p><a href="/wiki/Google" title="Google">Google</a> debuted its <a href="/wiki/Google_Chrome" title="Google Chrome">Chrome</a> browser in 2008, with the <a href="/wiki/V8_(JavaScript_engine)" title="V8 (JavaScript engine)">V8</a> JavaScript engine that was faster than its competition.<sup id="cite&#95;ref-25" class="reference"><a href="#cite_note-25"><span class="cite-bracket">&#91;</span>24<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-26" class="reference"><a href="#cite_note-26"><span class="cite-bracket">&#91;</span>25<span class="cite-bracket">&#93;</span></a></sup> The key innovation was <a href="/wiki/Just-in-time_compilation" title="Just-in-time compilation">just-in-time compilation</a> (JIT),<sup id="cite&#95;ref-27" class="reference"><a href="#cite_note-27"><span class="cite-bracket">&#91;</span>26<span class="cite-bracket">&#93;</span></a></sup> so other browser vendors needed to overhaul their engines for JIT.<sup id="cite&#95;ref-28" class="reference"><a href="#cite_note-28"><span class="cite-bracket">&#91;</span>27<span class="cite-bracket">&#93;</span></a></sup>
...
<div class="mw-heading mw-heading3"><h3 id="Reaching_maturity">Reaching maturity</h3></div>
<p>Ambitious work on the language continued for several years, culminating in an extensive collection of additions and refinements being formalized with the publication of <a href="/wiki/ECMAScript_6" class="mw-redirect" title="ECMAScript 6">ECMAScript 6</a> in 2015.<sup id="cite&#95;ref-29" class="reference"><a href="#cite_note-29"><span class="cite-bracket">&#91;</span>28<span class="cite-bracket">&#93;</span></a></sup>
</p><p>The creation of <a href="/wiki/Node.js" title="Node.js">Node.js</a> in 2009 by <a href="/wiki/Ryan_Dahl" title="Ryan Dahl">Ryan Dahl</a> sparked a significant increase in the usage of JavaScript outside of web browsers. Node combines the <a href="/wiki/V8_(JavaScript_engine)" title="V8 (JavaScript engine)">V8</a> engine, an <a href="/wiki/Event_loop" title="Event loop">event loop</a>, and <a href="/wiki/Input/output" title="Input/output">I/O</a> <a href="/wiki/Application_programming_interface" class="mw-redirect" title="Application programming interface">APIs</a>, thereby providing a stand-alone JavaScript runtime system.<sup id="cite&#95;ref-30" class="reference"><a href="#cite_note-30"><span class="cite-bracket">&#91;</span>29<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-b3&#95;31-0" class="reference"><a href="#cite_note-b3-31"><span class="cite-bracket">&#91;</span>30<span class="cite-bracket">&#93;</span></a></sup> As of 2018, Node had been used by millions of developers,<sup id="cite&#95;ref-32" class="reference"><a href="#cite_note-32"><span class="cite-bracket">&#91;</span>31<span class="cite-bracket">&#93;</span></a></sup> and <a href="/wiki/Npm_(software)" class="mw-redirect" title="Npm (software)">npm</a> had the most modules of any <a href="/wiki/Package_manager" title="Package manager">package manager</a> in the world.<sup id="cite&#95;ref-33" class="reference"><a href="#cite_note-33"><span class="cite-bracket">&#91;</span>32<span class="cite-bracket">&#93;</span></a></sup>
</p><p>The ECMAScript draft specification is currently maintained openly on <a href="/wiki/GitHub" title="GitHub">GitHub</a>,<sup id="cite&#95;ref-branscombe&#95;34-0" class="reference"><a href="#cite_note-branscombe-34"><span class="cite-bracket">&#91;</span>33<span class="cite-bracket">&#93;</span></a></sup> and editions are produced via regular annual snapshots.<sup id="cite&#95;ref-branscombe&#95;34-1" class="reference"><a href="#cite_note-branscombe-34"><span class="cite-bracket">&#91;</span>33<span class="cite-bracket">&#93;</span></a></sup> Potential revisions to the language are vetted through a comprehensive proposal process.<sup id="cite&#95;ref-35" class="reference"><a href="#cite_note-35"><span class="cite-bracket">&#91;</span>34<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-36" class="reference"><a href="#cite_note-36"><span class="cite-bracket">&#91;</span>35<span class="cite-bracket">&#93;</span></a></sup> Now, instead of edition numbers, developers check the status of upcoming features individually.<sup id="cite&#95;ref-branscombe&#95;34-2" class="reference"><a href="#cite_note-branscombe-34"><span class="cite-bracket">&#91;</span>33<span class="cite-bracket">&#93;</span></a></sup>
</p><p>The current JavaScript ecosystem has many <a href="/wiki/List_of_JavaScript_libraries" title="List of JavaScript libraries">libraries</a> and <a href="/wiki/Web_framework" title="Web framework">frameworks</a>, established programming practices, and substantial usage of JavaScript outside of web browsers.<sup id="cite&#95;ref-wired2024&#95;18-1" class="reference"><a href="#cite_note-wired2024-18"><span class="cite-bracket">&#91;</span>17<span class="cite-bracket">&#93;</span></a></sup> Plus, with the rise of <a href="/wiki/Single-page_application" title="Single-page application">single-page applications</a> and other JavaScript-heavy websites, several <a href="/wiki/Source-to-source_compiler" title="Source-to-source compiler">transpilers</a> have been created to aid the development process.<sup id="cite&#95;ref-transpilers&#95;37-0" class="reference"><a href="#cite_note-transpilers-37"><span class="cite-bracket">&#91;</span>36<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading2"><h2 id="Trademark">Trademark</h2></div>
<p>"JavaScript" is a <a href="/wiki/Trademark" title="Trademark">trademark</a> of <a href="/wiki/Oracle_Corporation" title="Oracle Corporation">Oracle Corporation</a> in the United States.<sup id="cite&#95;ref-38" class="reference"><a href="#cite_note-38"><span class="cite-bracket">&#91;</span>37<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-39" class="reference"><a href="#cite_note-39"><span class="cite-bracket">&#91;</span>38<span class="cite-bracket">&#93;</span></a></sup> The trademark was originally issued to <a href="/wiki/Sun_Microsystems" title="Sun Microsystems">Sun Microsystems</a> on 6 May 1997, and was transferred to Oracle when they acquired Sun in 2009.<sup id="cite&#95;ref-40" class="reference"><a href="#cite_note-40"><span class="cite-bracket">&#91;</span>39<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-41" class="reference"><a href="#cite_note-41"><span class="cite-bracket">&#91;</span>40<span class="cite-bracket">&#93;</span></a></sup>
</p><p>A letter was circulated in September 2024, spearheaded by <a href="/wiki/Ryan_Dahl" title="Ryan Dahl">Ryan Dahl</a>, calling on Oracle to free the JavaScript trademark.<sup id="cite&#95;ref-42" class="reference"><a href="#cite_note-42"><span class="cite-bracket">&#91;</span>41<span class="cite-bracket">&#93;</span></a></sup> <a href="/wiki/Brendan_Eich" title="Brendan Eich">Brendan Eich</a>, the original creator of JavaScript, was among the over 14,000 signatories who supported the initiative.
</p>
<div class="mw-heading mw-heading2"><h2 id="Website_client-side_usage">Website client-side usage</h2></div>
<p>JavaScript is the dominant <a href="/wiki/Client-side" class="mw-redirect" title="Client-side">client-side</a> <a href="/wiki/Scripting_language" title="Scripting language">scripting language</a> of the Web, with 99% of all <a href="/wiki/Website" title="Website">websites</a> using it for this purpose.<sup id="cite&#95;ref-deployedstats&#95;11-1" class="reference"><a href="#cite_note-deployedstats-11"><span class="cite-bracket">&#91;</span>10<span class="cite-bracket">&#93;</span></a></sup> Scripts are embedded in or included from <a href="/wiki/HTML" title="HTML">HTML</a> documents and interact with the <a href="/wiki/Document_Object_Model" title="Document Object Model">DOM</a>.
</p><p>All major <a href="/wiki/Web_browser" title="Web browser">web browsers</a> have a built-in <a href="/wiki/JavaScript_engine" class="mw-redirect" title="JavaScript engine">JavaScript engine</a> that executes the <a href="/wiki/Source_code" title="Source code">code</a> on the user's device.
</p>
<div class="mw-heading mw-heading3"><h3 id="Examples_of_scripted_behavior">Examples of scripted behavior</h3></div>
<ul><li>Loading new <a href="/wiki/Web_page" title="Web page">web page</a> content without reloading the page, via <a href="/wiki/Ajax_(programming)" title="Ajax (programming)">Ajax</a> or a <a href="/wiki/WebSocket" title="WebSocket">WebSocket</a>. For example, <a href="/wiki/User_(computing)" title="User (computing)">users</a> of <a href="/wiki/Social_media" title="Social media">social media</a> can send and receive messages without leaving the current page.</li>
<li>Web page animations, such as fading objects in and out, resizing, and moving them.</li>
<li>Playing <a href="/wiki/Browser_game" title="Browser game">browser games</a>.</li>
<li>Controlling the <a href="/wiki/Media_player_software" title="Media player software">playback</a> of <a href="/wiki/Streaming_media" title="Streaming media">streaming media</a>.</li>
<li>Generating <a href="/wiki/Pop-up_ad" title="Pop-up ad">pop-up ads</a> or alert boxes.</li>
<li><a href="/wiki/Data_validation" title="Data validation">Validating</a> input values of a <a href="/wiki/Form_(HTML)" class="mw-redirect" title="Form (HTML)">web form</a> before the data is sent to a <a href="/wiki/Web_server" title="Web server">web server</a>.</li>
<li>Logging data about the user's behavior then sending it to a server. The website owner can use this data for <a href="/wiki/Web_analytics" title="Web analytics">analytics</a>, <a href="/wiki/Ad_tracking" title="Ad tracking">ad tracking</a>, and <a href="/wiki/Personalization" title="Personalization">personalization</a>.</li>
<li>Redirecting a user to another page.</li>
<li>Storing and retrieving data on the user's device, via the <a href="/wiki/Web_storage" title="Web storage">storage</a> or <a href="/wiki/Indexed_Database_API" class="mw-redirect" title="Indexed Database API">IndexedDB</a> standards.</li></ul>
<div class="mw-heading mw-heading3"><h3 id="Libraries_and_frameworks">Libraries and frameworks</h3></div>
<p>Over 80% of websites use a third-party JavaScript <a href="/wiki/Library_(computing)" title="Library (computing)">library</a> or <a href="/wiki/Web_framework" title="Web framework">web framework</a> as part of their client-side scripting.<sup id="cite&#95;ref-lib&#95;usage&#95;43-0" class="reference"><a href="#cite_note-lib_usage-43"><span class="cite-bracket">&#91;</span>42<span class="cite-bracket">&#93;</span></a></sup>
</p><p><a href="/wiki/JQuery" title="JQuery">jQuery</a> is by far the most-used.<sup id="cite&#95;ref-lib&#95;usage&#95;43-1" class="reference"><a href="#cite_note-lib_usage-43"><span class="cite-bracket">&#91;</span>42<span class="cite-bracket">&#93;</span></a></sup> Other notable ones include <a href="/wiki/Angular_(web_framework)" title="Angular (web framework)">Angular</a>, <a href="/wiki/Bootstrap_(front-end_framework)" title="Bootstrap (front-end framework)">Bootstrap</a>, <a href="/wiki/Lodash" title="Lodash">Lodash</a>, <a href="/wiki/Modernizr" title="Modernizr">Modernizr</a>, <a href="/wiki/React_(software)" title="React (software)">React</a>, <a href="/wiki/Underscore.js" title="Underscore.js">Underscore</a>, and <a href="/wiki/Vue.js" title="Vue.js">Vue</a>.<sup id="cite&#95;ref-lib&#95;usage&#95;43-2" class="reference"><a href="#cite_note-lib_usage-43"><span class="cite-bracket">&#91;</span>42<span class="cite-bracket">&#93;</span></a></sup> Multiple options can be used in conjunction, such as jQuery and Bootstrap.<sup id="cite&#95;ref-44" class="reference"><a href="#cite_note-44"><span class="cite-bracket">&#91;</span>43<span class="cite-bracket">&#93;</span></a></sup>
</p><p>However, the term "Vanilla JS" was coined for websites not using any libraries or frameworks at all, instead relying entirely on standard JavaScript functionality.<sup id="cite&#95;ref-45" class="reference"><a href="#cite_note-45"><span class="cite-bracket">&#91;</span>44<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading2"><h2 id="Other_usage">Other usage<span class="anchor" id="Server-side&#95;JavaScript"></span><span class="anchor" id="Uses&#95;outside&#95;web&#95;pages"></span></h2></div>
...
</p><p>Initial attempts at promoting server-side JavaScript usage were <a href="/wiki/Netscape_Enterprise_Server" class="mw-redirect" title="Netscape Enterprise Server">Netscape Enterprise Server</a> and <a href="/wiki/Microsoft" title="Microsoft">Microsoft</a>'s <a href="/wiki/Internet_Information_Services" title="Internet Information Services">Internet Information Services</a>,<sup id="cite&#95;ref-46" class="reference"><a href="#cite_note-46"><span class="cite-bracket">&#91;</span>45<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-47" class="reference"><a href="#cite_note-47"><span class="cite-bracket">&#91;</span>46<span class="cite-bracket">&#93;</span></a></sup> but they were small niches.<sup id="cite&#95;ref-2009server&#95;48-0" class="reference"><a href="#cite_note-2009server-48"><span class="cite-bracket">&#91;</span>47<span class="cite-bracket">&#93;</span></a></sup> Server-side usage eventually started to grow in the late 2000s, with the creation of <a href="/wiki/Node.js" title="Node.js">Node.js</a> and <a href="/wiki/List_of_server-side_JavaScript_implementations" title="List of server-side JavaScript implementations">other approaches</a>.<sup id="cite&#95;ref-2009server&#95;48-1" class="reference"><a href="#cite_note-2009server-48"><span class="cite-bracket">&#91;</span>47<span class="cite-bracket">&#93;</span></a></sup>
</p><p><a href="/wiki/Electron_(software_framework)" title="Electron (software framework)">Electron</a>, <a href="/wiki/Apache_Cordova" title="Apache Cordova">Cordova</a>, <a href="/wiki/React_Native" title="React Native">React Native</a>, and other <a href="/wiki/Application_framework" title="Application framework">application frameworks</a> have been used to create many applications with behavior implemented in JavaScript. Other non-browser applications include <a href="/wiki/Adobe_Acrobat" title="Adobe Acrobat">Adobe Acrobat</a> support for scripting <a href="/wiki/PDF" title="PDF">PDF</a> documents<sup id="cite&#95;ref-49" class="reference"><a href="#cite_note-49"><span class="cite-bracket">&#91;</span>48<span class="cite-bracket">&#93;</span></a></sup> and <a href="/wiki/GNOME_Shell" title="GNOME Shell">GNOME Shell</a> extensions written in JavaScript.<sup id="cite&#95;ref-50" class="reference"><a href="#cite_note-50"><span class="cite-bracket">&#91;</span>49<span class="cite-bracket">&#93;</span></a></sup>
</p><p><a href="/wiki/Oracle_Corporation" title="Oracle Corporation">Oracle</a> used to provide <a href="/wiki/Nashorn_(JavaScript_engine)" title="Nashorn (JavaScript engine)"> Nashorn</a>, a JavaScript interpreter, as part of their <a href="/wiki/JDK" class="mw-redirect" title="JDK">Java Development Kit (JDK)</a> API library along with <b>jjs</b> a command line interpreter as of JDK version 8.  It was removed in JDK 15. As a replacement Oracle offered GraalJS which can also be used with the <a href="/wiki/OpenJDK" title="OpenJDK">OpenJDK</a>  which allows one to create and reference Java objects in JavaScript code and add runtime scripting in JavaScript to applications written in Java.<sup id="cite&#95;ref-51" class="reference"><a href="#cite_note-51"><span class="cite-bracket">&#91;</span>50<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-52" class="reference"><a href="#cite_note-52"><span class="cite-bracket">&#91;</span>51<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-53" class="reference"><a href="#cite_note-53"><span class="cite-bracket">&#91;</span>52<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-54" class="reference"><a href="#cite_note-54"><span class="cite-bracket">&#91;</span>53<span class="cite-bracket">&#93;</span></a></sup> 
</p><p>JavaScript has been used in some <a href="/wiki/Embedded_system" title="Embedded system">embedded systems</a>, usually by leveraging Node.js.<sup id="cite&#95;ref-55" class="reference"><a href="#cite_note-55"><span class="cite-bracket">&#91;</span>54<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-56" class="reference"><a href="#cite_note-56"><span class="cite-bracket">&#91;</span>55<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-57" class="reference"><a href="#cite_note-57"><span class="cite-bracket">&#91;</span>56<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading2"><h2 id="Execution">Execution</h2></div>
<div class="mw-heading mw-heading3"><h3 id="JavaScript_engine">JavaScript engine</h3></div>
<div class="excerpt-block"><style data-mw-deduplicate="TemplateStyles:r1066933788">.mw-parser-output .excerpt-hat .mw-editsection-like{font-style:normal}</style><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable dablink excerpt-hat selfref">This section is an excerpt from <a href="/wiki/List_of_JavaScript_engines" title="List of JavaScript engines">List of JavaScript engines</a>.<span class="mw-editsection-like plainlinks"><span class="mw-editsection-bracket">[</span><a class="external text" href="https://en.wikipedia.org/w/index.php?title=List_of_JavaScript_engines&amp;action=edit">edit</a><span class="mw-editsection-bracket">]</span></span></div><div class="excerpt">
<p>The first <a href="/wiki/Software_engine" title="Software engine">engines</a> for JavaScript were mere <a href="/wiki/Interpreter_(computing)" title="Interpreter (computing)">interpreters</a> of the <a href="/wiki/Source_code" title="Source code">source code</a>, but all relevant modern engines use <a href="/wiki/Just-in-time_compilation" title="Just-in-time compilation">just-in-time compilation</a> for improved performance.<sup id="cite&#95;ref-58" class="reference"><a href="#cite_note-58"><span class="cite-bracket">&#91;</span>57<span class="cite-bracket">&#93;</span></a></sup> JavaScript engines are typically developed by <a href="/wiki/Web_browser" title="Web browser">web browser</a> vendors, and every major browser has one. In a browser, the JavaScript engine runs in concert with the <a href="/wiki/Browser_engine" title="Browser engine">rendering engine</a> via the <a href="/wiki/Document_Object_Model" title="Document Object Model">Document Object Model</a> and <a href="/wiki/Web_IDL" title="Web IDL">Web IDL</a> bindings.<sup id="cite&#95;ref-59" class="reference"><a href="#cite_note-59"><span class="cite-bracket">&#91;</span>58<span class="cite-bracket">&#93;</span></a></sup> However, the use of JavaScript engines is not limited to browsers; for example, the <a href="/wiki/V8_(JavaScript_engine)" title="V8 (JavaScript engine)">V8 engine</a> is a core component of the <a href="/wiki/Node.js" title="Node.js">Node.js</a> <a href="/wiki/Runtime_system" title="Runtime system">runtime system</a>.<sup id="cite&#95;ref-List&#95;of&#95;JavaScript&#95;engines&#95;v8&#95;doc&#95;60-0" class="reference"><a href="#cite_note-List_of_JavaScript_engines_v8_doc-60"><span class="cite-bracket">&#91;</span>59<span class="cite-bracket">&#93;</span></a></sup> They are also called <a href="/wiki/ECMAScript" title="ECMAScript">ECMAScript</a> engines, after the official name of the specification. With the advent of <a href="/wiki/WebAssembly" title="WebAssembly">WebAssembly</a>, some engines can also execute this code in the same <a href="/wiki/Sandbox_(computer_security)" title="Sandbox (computer security)">sandbox</a> as regular JavaScript code.<sup id="cite&#95;ref-List&#95;of&#95;JavaScript&#95;engines&#95;Wasm&#95;61-0" class="reference"><a href="#cite_note-List_of_JavaScript_engines_Wasm-61"><span class="cite-bracket">&#91;</span>60<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-List&#95;of&#95;JavaScript&#95;engines&#95;v8&#95;doc&#95;60-1" class="reference"><a href="#cite_note-List_of_JavaScript_engines_v8_doc-60"><span class="cite-bracket">&#91;</span>59<span class="cite-bracket">&#93;</span></a></sup>
</p>
</div></div>
<div class="mw-heading mw-heading3"><h3 id="Runtime_system">Runtime system</h3></div>
<p>A JavaScript engine must be embedded within a <a href="/wiki/Runtime_system" title="Runtime system">runtime system</a> (such as a <a href="/wiki/Web_browser" title="Web browser">web browser</a> or a standalone system) to enable scripts to interact with the broader environment. The runtime system includes the necessary APIs for <a href="/wiki/Input/output" title="Input/output">input/output</a> operations, such as <a href="/wiki/Computer_network" title="Computer network">networking</a>, <a href="/wiki/Data_storage" title="Data storage">storage</a>, and <a href="/wiki/Computer_graphics" title="Computer graphics">graphics</a>, and provides the ability to import scripts.
</p><p>JavaScript is a single-<a href="/wiki/Thread_(computing)" title="Thread (computing)">threaded</a> language. The runtime processes <a href="/wiki/Message_(computer_science)" class="mw-redirect" title="Message (computer science)">messages</a> from a <a href="/wiki/Queue_(abstract_data_type)" title="Queue (abstract data type)">queue</a> one at a time, and it calls a <a href="/wiki/Subroutine" class="mw-redirect" title="Subroutine">function</a> associated with each new message, creating a <a href="/wiki/Call_stack" title="Call stack">call stack</a> frame with the function's <a href="/wiki/Parameter_(computer_programming)" title="Parameter (computer programming)">arguments</a> and <a href="/wiki/Local_variable" title="Local variable">local variables</a>. The call stack shrinks and grows based on the function's needs. When the call stack is empty upon function completion, JavaScript proceeds to the next message in the queue. This is called the <a href="/wiki/Event_loop" title="Event loop">event loop</a>, described as "run to completion" because each message is fully processed before the next message is considered. However, the language's <a href="/wiki/Concurrency_(computer_science)" title="Concurrency (computer science)">concurrency model</a> describes the event loop as <a href="/wiki/Asynchronous_I/O" title="Asynchronous I/O">non-blocking</a>: program I/O is performed using <a href="/wiki/Event_(computing)" title="Event (computing)">events</a> and <a href="/wiki/Callback_(computer_programming)" title="Callback (computer programming)">callback functions</a>. This means, for example, that JavaScript can process a mouse click while waiting for a database query to return information.<sup id="cite&#95;ref-62" class="reference"><a href="#cite_note-62"><span class="cite-bracket">&#91;</span>61<span class="cite-bracket">&#93;</span></a></sup>
</p><p>The notable standalone runtimes are <a href="/wiki/Node.js" title="Node.js">Node.js</a>, <a href="/wiki/Deno_(software)" title="Deno (software)">Deno</a>, and <a href="/wiki/Bun_(software)" title="Bun (software)">Bun</a>.
</p>
<div class="mw-heading mw-heading2"><h2 id="Features">Features</h2></div>
<p>The following features are common to all conforming ECMAScript implementations unless explicitly specified otherwise. The number of cited reserved words including keywords is 50–60 and varies depending on the implementation.
</p>
<div class="mw-heading mw-heading3"><h3 id="Imperative_and_structured">Imperative and structured</h3></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Structured_programming" title="Structured programming">Structured programming</a></div>
<p>JavaScript supports much of the <a href="/wiki/Structured_programming" title="Structured programming">structured programming</a> syntax from <a href="/wiki/C_(computer_language)" class="mw-redirect" title="C (computer language)">C</a> (e.g., <code>if</code> statements, <code>while</code> loops, <code>switch</code> statements, <code>do while</code> loops, etc.). One partial exception is <a href="/wiki/Scope_(computer_science)" class="mw-redirect" title="Scope (computer science)">scoping</a>: originally JavaScript only had <a href="/wiki/Function_scoping" class="mw-redirect" title="Function scoping">function scoping</a> with <code>var</code>; <a href="/wiki/Block_scoping" class="mw-redirect" title="Block scoping">block scoping</a> was added in ECMAScript 2015 with the keywords <code>let</code> and <code><a href="/wiki/Const_(computer_programming)" title="Const (computer programming)">const</a></code>. Like C, JavaScript makes a distinction between <a href="/wiki/Expression_(computer_science)" title="Expression (computer science)">expressions</a> and <a href="/wiki/Statement_(computer_science)" title="Statement (computer science)">statements</a>. One syntactic difference from C is <a href="/wiki/Defensive_semicolon" class="mw-redirect" title="Defensive semicolon">automatic semicolon insertion</a>, which allow semicolons (which terminate statements) to be omitted.<sup id="cite&#95;ref-Flanagan2006&#95;63-0" class="reference"><a href="#cite_note-Flanagan2006-63"><span class="cite-bracket">&#91;</span>62<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading3"><h3 id="Weakly_typed">Weakly typed</h3></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Further information: <a href="/wiki/Weakly_typed" class="mw-redirect" title="Weakly typed">Weakly typed</a></div>
<p>JavaScript is <a href="/wiki/Strong_and_weak_typing" class="mw-redirect" title="Strong and weak typing">weakly typed</a>, which means certain types are implicitly cast depending on the operation used.<sup id="cite&#95;ref-casting&#95;rules&#95;64-0" class="reference"><a href="#cite_note-casting_rules-64"><span class="cite-bracket">&#91;</span>63<span class="cite-bracket">&#93;</span></a></sup>
</p>
...
<li>Both unary operators (<code>+</code>, <code>-</code>) always cast the operand to a number. However, <code>+</code> always casts to <code>Number</code> (<a href="/wiki/Double-precision_floating-point_format" title="Double-precision floating-point format">binary64</a>) while <code>-</code> preserves <code>BigInt</code> (<a href="/wiki/Arbitrary-precision_arithmetic" title="Arbitrary-precision arithmetic">integer</a>)<sup id="cite&#95;ref-65" class="reference"><a href="#cite_note-65"><span class="cite-bracket">&#91;</span>64<span class="cite-bracket">&#93;</span></a></sup></li></ul>
<p>Values are cast to strings as follows:<sup id="cite&#95;ref-casting&#95;rules&#95;64-1" class="reference"><a href="#cite_note-casting_rules-64"><span class="cite-bracket">&#91;</span>63<span class="cite-bracket">&#93;</span></a></sup>
</p>
...
</p><p>JavaScript has received criticism for the way it implements these conversions as the complexity of the rules can be mistaken for inconsistency.<sup id="cite&#95;ref-66" class="reference"><a href="#cite_note-66"><span class="cite-bracket">&#91;</span>65<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-casting&#95;rules&#95;64-2" class="reference"><a href="#cite_note-casting_rules-64"><span class="cite-bracket">&#91;</span>63<span class="cite-bracket">&#93;</span></a></sup> For example, when adding a number to a string, the number will be cast to a string before performing concatenation, but when subtracting a number from a string, the string is cast to a number before performing subtraction.
</p>
...
<p>Often also mentioned is <code>{} + []</code> resulting in <code>0</code> (number). This is misleading: the <code>{}</code> is interpreted as an empty code block instead of an empty object, and the empty array is cast to a number by the remaining unary <code>+</code> operator. If the expression is wrapped in parentheses - <code>({} + [])</code> – the curly brackets are interpreted as an empty object and the result of the expression is <code>"[object Object]"</code> as expected.<sup id="cite&#95;ref-casting&#95;rules&#95;64-3" class="reference"><a href="#cite_note-casting_rules-64"><span class="cite-bracket">&#91;</span>63<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading3"><h3 id="Dynamic">Dynamic</h3></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Dynamic_programming" title="Dynamic programming">Dynamic programming</a></div>
<div class="mw-heading mw-heading4"><h4 id="Typing">Typing</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Dynamic_typing" class="mw-redirect" title="Dynamic typing">Dynamic typing</a></div>
<p>JavaScript is <a href="/wiki/Dynamic_typing" class="mw-redirect" title="Dynamic typing">dynamically typed</a> like most other <a href="/wiki/Scripting_language" title="Scripting language">scripting languages</a>. A <a href="/wiki/Type_system" title="Type system">type</a> is associated with a <a href="/wiki/Value_(computer_science)" title="Value (computer science)">value</a> rather than an expression. For example, a <a href="/wiki/Variable_(programming)" class="mw-redirect" title="Variable (programming)">variable</a> initially bound to a number may be reassigned to a <a href="/wiki/String_(computer_science)" title="String (computer science)">string</a>.<sup id="cite&#95;ref-67" class="reference"><a href="#cite_note-67"><span class="cite-bracket">&#91;</span>66<span class="cite-bracket">&#93;</span></a></sup> JavaScript supports various ways to test the type of objects, including <a href="/wiki/Duck_typing" title="Duck typing">duck typing</a>.<sup id="cite&#95;ref-FOOTNOTEFlanagan2006176–178&#95;68-0" class="reference"><a href="#cite_note-FOOTNOTEFlanagan2006176–178-68"><span class="cite-bracket">&#91;</span>67<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading4"><h4 id="Run-time_evaluation">Run-time evaluation</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Eval" title="Eval">eval</a></div>
<p>JavaScript includes an <code><a href="/wiki/Eval" title="Eval">eval</a></code> function that can execute statements provided as strings at run-time.
</p>
<div class="mw-heading mw-heading3"><h3 id="Object-orientation_(prototype-based)"><span id="Object-orientation_.28prototype-based.29"></span>Object-orientation (prototype-based)</h3></div>
...
<div class="mw-heading mw-heading4"><h4 id="Prototypes">Prototypes</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Prototype-based_programming" title="Prototype-based programming">Prototype-based programming</a></div><p>
JavaScript uses <a href="/wiki/Prototype-based_programming" title="Prototype-based programming">prototypes</a> where many other object-oriented languages use <a href="/wiki/Class_(computer_science)" class="mw-redirect" title="Class (computer science)">classes</a> for <a href="/wiki/Inheritance_(object-oriented_programming)" title="Inheritance (object-oriented programming)">inheritance</a>,<sup id="cite&#95;ref-70" class="reference"><a href="#cite_note-70"><span class="cite-bracket">&#91;</span>69<span class="cite-bracket">&#93;</span></a></sup> but it's still possible to simulate most class-based features with the prototype system.<sup id="cite&#95;ref-71" class="reference"><a href="#cite_note-71"><span class="cite-bracket">&#91;</span>70<span class="cite-bracket">&#93;</span></a></sup> Additionally, <a href="/wiki/ECMAScript" title="ECMAScript">ECMAScript version 6</a> (released June 2015) introduced the keywords <b>class</b>, <b>extends</b> and <b>super</b>, which serve as syntactic sugar to abstract the underlying prototypal inheritance system with a more conventional interface. Constructors are declared by specifying a method named <b>constructor</b>, and all classes are automatically subclasses of the base class Object, similarly to Java. </p><div class="mw-highlight mw-highlight-lang-javascript mw-content-ltr" dir="ltr"><pre><span></span><span class="kd">class</span><span class="w"> </span><span class="nx">Person</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">    </span><span class="kr">constructor</span><span class="p">(</span><span class="nx">name</span><span class="p">,</span><span class="w"> </span><span class="nx">id</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">bob</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Student</span><span class="p">(</span><span class="s2">&quot;Robert&quot;</span><span class="p">,</span><span class="w"> </span><span class="mf">12345</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">bob</span><span class="p">.</span><span class="nx">name</span><span class="p">);</span><span class="w"> </span><span class="c1">// Robert</span>
</pre></div><p>Though the underlying object mechanism is still based on prototypes, the newer syntax is similar to other object oriented languages. Private variables are declared by prefixing the field name with a <a href="/wiki/Number_sign" title="Number sign">number sign</a> (#), and <a href="/wiki/Polymorphism_(computer_science)" title="Polymorphism (computer science)">polymorphism</a> is not directly supported, although it can be emulated by manually calling different functions depending on the number and type of arguments provided.<sup id="cite&#95;ref-JavaScriptNext&#95;72-0" class="reference"><a href="#cite_note-JavaScriptNext-72"><span class="cite-bracket">&#91;</span>71<span class="cite-bracket">&#93;</span></a></sup>
</p><div class="mw-heading mw-heading4"><h4 id="Functions_as_object_constructors">Functions as object constructors</h4></div><p>
Functions double as object constructors, along with their typical role. Prefixing a function call with <i>new</i> will create an instance of a prototype, inheriting properties and methods from the constructor (including properties from the <code>Object</code> prototype).<sup id="cite&#95;ref-Haverbeke2024&#95;73-0" class="reference"><a href="#cite_note-Haverbeke2024-73"><span class="cite-bracket">&#91;</span>72<span class="cite-bracket">&#93;</span></a></sup> ECMAScript 5 offers the <code>Object.create</code> method, allowing explicit creation of an instance without automatically inheriting from the <code>Object</code> prototype (older environments can assign the prototype to <code>null</code>).<sup id="cite&#95;ref-74" class="reference"><a href="#cite_note-74"><span class="cite-bracket">&#91;</span>73<span class="cite-bracket">&#93;</span></a></sup> The constructor's <code>prototype</code> property determines the object used for the new object's internal prototype. New methods can be added by modifying the prototype of the function used as a constructor.</p><div class="mw-highlight mw-highlight-lang-javascript mw-content-ltr" dir="ltr"><pre><span></span><span class="c1">// This code is completely equivalent to the previous snippet</span>
...
<span class="kd">function</span><span class="w"> </span><span class="nx">Student</span><span class="p">(</span><span class="nx">name</span><span class="p">,</span><span class="w"> </span><span class="nx">id</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">Person</span><span class="p">.</span><span class="nx">call</span><span class="p">(</span><span class="k">this</span><span class="p">,</span><span class="w"> </span><span class="nx">name</span><span class="p">);</span>
<span class="w">    </span><span class="k">this</span><span class="p">.</span><span class="nx">id</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">id</span><span class="p">;</span>
<span class="p">}</span>

<span class="kd">var</span><span class="w"> </span><span class="nx">bob</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Student</span><span class="p">(</span><span class="s2">&quot;Robert&quot;</span><span class="p">,</span><span class="w"> </span><span class="mf">12345</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">bob</span><span class="p">.</span><span class="nx">name</span><span class="p">);</span><span class="w"> </span><span class="c1">// Robert</span>
</pre></div><p>JavaScript's built-in classes, such as <code>Array</code> and <code>Object</code>, also have prototypes that can be modified. However, it's generally considered bad practice to <a href="/wiki/Monkey_patch" title="Monkey patch">modify built-in objects</a>, because third-party code may use or inherit methods and properties from these objects, and may not expect the prototype to be modified.<sup id="cite&#95;ref-75" class="reference"><a href="#cite_note-75"><span class="cite-bracket">&#91;</span>74<span class="cite-bracket">&#93;</span></a></sup>
</p><div class="mw-heading mw-heading4"><h4 id="Functions_as_methods">Functions as methods</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Method_(computer_science)" class="mw-redirect" title="Method (computer science)">Method (computer science)</a></div>
<p>Unlike in many object-oriented languages, in JavaScript there is no distinction between a function definition and a <a href="/wiki/Method_(computer_science)" class="mw-redirect" title="Method (computer science)">method</a> definition. Rather, the distinction occurs during function calling. When a function is called as a method of an object, the function's local <i>this</i> keyword is bound to that object for that invocation.
</p>
<div class="mw-heading mw-heading3"><h3 id="Functional">Functional</h3></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Functional_programming" title="Functional programming">Functional programming</a></div>
<p>JavaScript <a href="/wiki/Subroutine" class="mw-redirect" title="Subroutine">functions</a> are <a href="/wiki/First-class_function" title="First-class function">first-class</a>; a function is considered to be an object.<sup id="cite&#95;ref-76" class="reference"><a href="#cite_note-76"><span class="cite-bracket">&#91;</span>75<span class="cite-bracket">&#93;</span></a></sup> As such, a function may have properties and methods, such as <code>.call()</code> and <code>.bind()</code>.<sup id="cite&#95;ref-77" class="reference"><a href="#cite_note-77"><span class="cite-bracket">&#91;</span>76<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading4"><h4 id="Lexical_closure">Lexical closure</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Closure_(computer_programming)" title="Closure (computer programming)">Closure (computer programming)</a></div>
<p>A <i>nested</i> function is a function defined within another function. It is created each time the outer function is invoked.
</p><p>In addition, each nested function forms a <a href="/wiki/Closure_(computer_programming)" title="Closure (computer programming)">lexical closure</a>: the <a href="/wiki/Scope_(programming)#Lexical_scoping_vs._dynamic_scoping" class="mw-redirect" title="Scope (programming)">lexical scope</a> of the outer function (including any constant, local variable, or argument value) becomes part of the internal state of each inner function object, even after execution of the outer function concludes.<sup id="cite&#95;ref-FOOTNOTEFlanagan2006141&#95;78-0" class="reference"><a href="#cite_note-FOOTNOTEFlanagan2006141-78"><span class="cite-bracket">&#91;</span>77<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading4"><h4 id="Anonymous_function">Anonymous function</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Anonymous_function" title="Anonymous function">Anonymous function</a></div>
<p>JavaScript also supports <a href="/wiki/Anonymous_function" title="Anonymous function">anonymous functions</a>.
</p>
<div class="mw-heading mw-heading3"><h3 id="Delegative">Delegative</h3></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Delegation_(object-oriented_programming)" title="Delegation (object-oriented programming)">Delegation (object-oriented programming)</a></div>
...
<div class="mw-heading mw-heading4"><h4 id="Functions_as_roles_(Traits_and_Mixins)"><span id="Functions_as_roles_.28Traits_and_Mixins.29"></span>Functions as roles (Traits and Mixins)</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main articles: <a href="/wiki/Role-oriented_programming" title="Role-oriented programming">Role-oriented programming</a>, <a href="/wiki/Traits_(computer_science)" class="mw-redirect" title="Traits (computer science)">Traits (computer science)</a>, and <a href="/wiki/Mixin" title="Mixin">Mixin</a></div>
<p>JavaScript natively supports various function-based implementations of <a href="/wiki/Role-oriented_programming" title="Role-oriented programming">Role</a><sup id="cite&#95;ref-79" class="reference"><a href="#cite_note-79"><span class="cite-bracket">&#91;</span>78<span class="cite-bracket">&#93;</span></a></sup> patterns like <a href="/wiki/Traits_(computer_science)" class="mw-redirect" title="Traits (computer science)">Traits</a><sup id="cite&#95;ref-80" class="reference"><a href="#cite_note-80"><span class="cite-bracket">&#91;</span>79<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-81" class="reference"><a href="#cite_note-81"><span class="cite-bracket">&#91;</span>80<span class="cite-bracket">&#93;</span></a></sup> and <a href="/wiki/Mixin" title="Mixin">Mixins</a>.<sup id="cite&#95;ref-82" class="reference"><a href="#cite_note-82"><span class="cite-bracket">&#91;</span>81<span class="cite-bracket">&#93;</span></a></sup> Such a function defines additional behavior by at least one method bound to the <code>this</code> keyword within its <code>function</code> body. A Role then has to be delegated explicitly via <code>call</code> or <code>apply</code> to objects that need to feature additional behavior that is not shared via the prototype chain.
</p>
<div class="mw-heading mw-heading4"><h4 id="Object_composition_and_inheritance">Object composition and inheritance</h4></div>
...
<div class="mw-heading mw-heading4"><h4 id="Zero-based_numbering">Zero-based numbering</h4></div>
<p>JavaScript is a <a href="/wiki/Zero-based_numbering#Usage_in_programming_languages" title="Zero-based numbering">zero-index</a> language.
</p>
<div class="mw-heading mw-heading4"><h4 id="Variadic_functions">Variadic functions</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Variadic_function" title="Variadic function">Variadic function</a></div>
<p>An indefinite number of parameters can be passed to a function. The function can access them through <a href="/wiki/Formal_parameter" class="mw-redirect" title="Formal parameter">formal parameters</a> and also through the local <code>arguments</code> object. <a href="/wiki/Variadic_functions" class="mw-redirect" title="Variadic functions">Variadic functions</a> can also be created by using the <code><a rel="nofollow" class="external text" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/bind">bind</a></code> method.
</p>
<div class="mw-heading mw-heading4"><h4 id="Array_and_object_literals">Array and object literals</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main articles: <a href="/wiki/Associative_arrays" class="mw-redirect" title="Associative arrays">Associative arrays</a> and <a href="/wiki/Object_literal" class="mw-redirect" title="Object literal">Object literal</a></div>
<p>Like in many scripting languages, arrays and objects (<a href="/wiki/Associative_arrays" class="mw-redirect" title="Associative arrays">associative arrays</a> in other languages) can each be created with a succinct shortcut syntax. In fact, these <a href="/wiki/Object_literal" class="mw-redirect" title="Object literal">literals</a> form the basis of the <a href="/wiki/JSON" title="JSON">JSON</a> data format.
</p>
<div class="mw-heading mw-heading4"><h4 id="Regular_expressions">Regular expressions</h4></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Regular_expression" title="Regular expression">Regular expression</a></div>
<p>JavaScript supports <a href="/wiki/Regular_expression" title="Regular expression">regular expressions</a> for text searches and manipulation.<sup id="cite&#95;ref-Haverbeke2024&#95;73-1" class="reference"><a href="#cite_note-Haverbeke2024-73"><span class="cite-bracket">&#91;</span>72<span class="cite-bracket">&#93;</span></a></sup><sup class="reference nowrap"><span title="Page: 139">&#58;&#8202;139&#8202;</span></sup>
</p>
<div class="mw-heading mw-heading5"><h5 id="Promises">Promises</h5></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Futures_and_promises" title="Futures and promises">Futures and promises</a></div>
<p>A built-in Promise object provides functionality for handling promises and associating handlers with an asynchronous action's eventual result. JavaScript supplies combinator methods, which allow developers to combine multiple JavaScript promises and do operations based on different scenarios. The methods introduced are: Promise.race, Promise.all, Promise.allSettled and Promise.any.
</p>
<div class="mw-heading mw-heading5"><h5 id="Async/await"><span id="Async.2Fawait"></span>Async/await</h5></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/Async/await" title="Async/await">Async/await</a></div>
<p>Async/await allows an asynchronous, non-blocking function to be structured in a way similar to an ordinary synchronous function. Asynchronous, non-blocking code can be written, with minimal overhead, structured similarly to traditional synchronous, blocking code.
</p>
<div class="mw-heading mw-heading3"><h3 id="Vendor-specific_extensions">Vendor-specific extensions</h3></div>
<p>Historically, some <a href="/wiki/JavaScript_engine" class="mw-redirect" title="JavaScript engine">JavaScript engines</a> supported these non-standard features:
</p>
<ul><li><a href="/wiki/List_comprehension" title="List comprehension">array comprehensions</a> and generator expressions (like Python)</li>
<li>concise function expressions (<code>function(args) expr</code>; this experimental syntax predated arrow functions)</li>
<li><a href="/wiki/ECMAScript_for_XML" title="ECMAScript for XML">ECMAScript for XML</a> (E4X), an extension that adds native XML support to ECMAScript (unsupported in Firefox since version 21<sup id="cite&#95;ref-83" class="reference"><a href="#cite_note-83"><span class="cite-bracket">&#91;</span>82<span class="cite-bracket">&#93;</span></a></sup>)</li></ul>
<div class="mw-heading mw-heading2"><h2 id="Syntax">Syntax</h2></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Main article: <a href="/wiki/JavaScript_syntax" title="JavaScript syntax">JavaScript syntax</a></div>
<p><a href="/wiki/Variable_(computer_science)" class="mw-redirect" title="Variable (computer science)">Variables</a> in JavaScript can be defined using either the <code>var</code>,<sup id="cite&#95;ref-84" class="reference"><a href="#cite_note-84"><span class="cite-bracket">&#91;</span>83<span class="cite-bracket">&#93;</span></a></sup> <code>let</code><sup id="cite&#95;ref-moz&#95;let&#95;85-0" class="reference"><a href="#cite_note-moz_let-85"><span class="cite-bracket">&#91;</span>84<span class="cite-bracket">&#93;</span></a></sup> or <code>const</code><sup id="cite&#95;ref-moz&#95;const&#95;86-0" class="reference"><a href="#cite_note-moz_const-86"><span class="cite-bracket">&#91;</span>85<span class="cite-bracket">&#93;</span></a></sup> keywords.  Variables defined without keywords will be defined at the global scope.
...
</p><p>Here is an example of JavaScript syntax.
</p>
...
<span class="c1">// var is generally considered bad practice and let and const are usually preferred.</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">x</span><span class="p">;</span>

<span class="c1">// Variables can be manually set to `undefined` like so</span>
<span class="kd">let</span><span class="w"> </span><span class="nx">x2</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="kc">undefined</span><span class="p">;</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">z</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s2">&quot;this value cannot be reassigned!&quot;</span><span class="p">;</span>

<span class="c1">// Declares a global-scoped variable and assigns 3.  This is generally considered</span>
<span class="c1">// bad practice, and will not work if strict mode is on.</span>
<span class="nx">t</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">3</span><span class="p">;</span>

<span class="c1">// Declares a variable named `myNumber`, and assigns a number literal (the value</span>
<span class="c1">// `2`) to it.</span>
<span class="kd">let</span><span class="w"> </span><span class="nx">myNumber</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">2</span><span class="p">;</span>
...
<span class="nx">myNumber</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s2">&quot;foo&quot;</span><span class="p">;</span>
</pre></div>
<p>Note the <a href="/wiki/Comment_(computer_programming)" title="Comment (computer programming)">comments</a> in the examples above, all of which were preceded with two <a href="/wiki/Slash_(punctuation)" title="Slash (punctuation)">forward slashes</a>.
</p><p>More examples can be found at the <a href="https://en.wikibooks.org/wiki/JavaScript/Syntax_examples" class="extiw" title="wikibooks:JavaScript/Syntax examples">Wikibooks page on JavaScript syntax examples</a>.
</p>
<div class="mw-heading mw-heading2"><h2 id="Security">Security</h2></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">See also: <a href="/wiki/Browser_security" title="Browser security">Browser security</a></div>
...
</p><p>There are subsets of general JavaScript—ADsafe, Secure ECMAScript (SES)—that provide greater levels of security, especially on code created by third parties (such as advertisements).<sup id="cite&#95;ref-87" class="reference"><a href="#cite_note-87"><span class="cite-bracket">&#91;</span>86<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-88" class="reference"><a href="#cite_note-88"><span class="cite-bracket">&#91;</span>87<span class="cite-bracket">&#93;</span></a></sup> Closure Toolkit is another project for safe embedding and isolation of third-party JavaScript and HTML.<sup id="cite&#95;ref-89" class="reference"><a href="#cite_note-89"><span class="cite-bracket">&#91;</span>88<span class="cite-bracket">&#93;</span></a></sup>
...
<div class="mw-heading mw-heading3"><h3 id="Misplaced_trust_in_the_client">Misplaced trust in the client</h3></div>
...
<ul><li>Website authors cannot perfectly conceal how their JavaScript operates because the raw source code must be sent to the client. The code can be <a href="/wiki/Obfuscated_code" class="mw-redirect" title="Obfuscated code">obfuscated</a>, but obfuscation can be reverse-engineered.</li>
...
<li>Scripts can be selectively disabled, so JavaScript cannot be relied on to prevent operations such as right-clicking on an image to save it.<sup id="cite&#95;ref-91" class="reference"><a href="#cite_note-91"><span class="cite-bracket">&#91;</span>90<span class="cite-bracket">&#93;</span></a></sup></li>
<li>It is considered very bad practice to embed sensitive information such as passwords in JavaScript because it can be extracted by an attacker.<sup id="cite&#95;ref-92" class="reference"><a href="#cite_note-92"><span class="cite-bracket">&#91;</span>91<span class="cite-bracket">&#93;</span></a></sup></li>
<li><a href="/wiki/Prototype_pollution" title="Prototype pollution">Prototype pollution</a> is a runtime vulnerability in which attackers can overwrite arbitrary properties in an object's prototype.</li></ul>
<div class="mw-heading mw-heading3"><h3 id="Misplaced_trust_in_developers">Misplaced trust in developers</h3></div>
<p>Package management systems such as <a href="/wiki/Npm_(software)" class="mw-redirect" title="Npm (software)">npm</a> and Bower are popular with JavaScript developers. Such systems allow a developer to easily manage their program's dependencies upon other developers' program libraries. Developers trust that the maintainers of the libraries will keep them secure and up to date, but that is not always the case. A vulnerability has emerged because of this blind trust. Relied-upon libraries can have new releases that cause bugs or vulnerabilities to appear in all programs that rely upon the libraries. Inversely, a library can go unpatched with known vulnerabilities out in the wild. In a study done looking over a sample of 133,000 websites, researchers found 37% of the websites included a library with at least one known vulnerability.<sup id="cite&#95;ref-jslibs&#95;93-0" class="reference"><a href="#cite_note-jslibs-93"><span class="cite-bracket">&#91;</span>92<span class="cite-bracket">&#93;</span></a></sup> "The median lag between the oldest library version used on each website and the newest available version of that library is 1,177 days in ALEXA, and development of some libraries still in active use ceased years ago."<sup id="cite&#95;ref-jslibs&#95;93-1" class="reference"><a href="#cite_note-jslibs-93"><span class="cite-bracket">&#91;</span>92<span class="cite-bracket">&#93;</span></a></sup> Another possibility is that the maintainer of a library may remove the library entirely. This occurred in March 2016 when Azer Koçulu removed his repository from npm. This caused tens of thousands of programs and websites depending upon his libraries to break.<sup id="cite&#95;ref-94" class="reference"><a href="#cite_note-94"><span class="cite-bracket">&#91;</span>93<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-95" class="reference"><a href="#cite_note-95"><span class="cite-bracket">&#91;</span>94<span class="cite-bracket">&#93;</span></a></sup>
</p>
<div class="mw-heading mw-heading3"><h3 id="Browser_and_plugin_coding_errors">Browser and plugin coding errors</h3></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">Further information: <a href="/wiki/Buffer_overflow" title="Buffer overflow">Buffer overflow</a></div>
...
</p><p>These flaws have affected major browsers including Firefox,<sup id="cite&#95;ref-96" class="reference"><a href="#cite_note-96"><span class="cite-bracket">&#91;</span>95<span class="cite-bracket">&#93;</span></a></sup> Internet Explorer,<sup id="cite&#95;ref-97" class="reference"><a href="#cite_note-97"><span class="cite-bracket">&#91;</span>96<span class="cite-bracket">&#93;</span></a></sup> and Safari.<sup id="cite&#95;ref-98" class="reference"><a href="#cite_note-98"><span class="cite-bracket">&#91;</span>97<span class="cite-bracket">&#93;</span></a></sup>
</p><p>Plugins, such as video players, <a href="/wiki/Adobe_Flash#Flash_client_security" title="Adobe Flash">Adobe Flash</a>, and the wide range of <a href="/wiki/ActiveX" title="ActiveX">ActiveX</a> controls enabled by default in Microsoft Internet Explorer, may also have flaws exploitable via JavaScript (such flaws have been exploited in the past).<sup id="cite&#95;ref-99" class="reference"><a href="#cite_note-99"><span class="cite-bracket">&#91;</span>98<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-100" class="reference"><a href="#cite_note-100"><span class="cite-bracket">&#91;</span>99<span class="cite-bracket">&#93;</span></a></sup>
</p><p>In Windows Vista, Microsoft has attempted to contain the risks of bugs such as buffer overflows by running the Internet Explorer process with limited privileges.<sup id="cite&#95;ref-101" class="reference"><a href="#cite_note-101"><span class="cite-bracket">&#91;</span>100<span class="cite-bracket">&#93;</span></a></sup> <a href="/wiki/Google_Chrome" title="Google Chrome">Google Chrome</a> similarly confines its page renderers to their own "<a href="/wiki/Sandbox_(computer_security)" title="Sandbox (computer security)">sandbox</a>".
</p>
<div class="mw-heading mw-heading3"><h3 id="Sandbox_implementation_errors">Sandbox implementation errors</h3></div>
...
</p><p>Incorrectly granting privileges to JavaScript from the Web has played a role in vulnerabilities in both Internet Explorer<sup id="cite&#95;ref-102" class="reference"><a href="#cite_note-102"><span class="cite-bracket">&#91;</span>101<span class="cite-bracket">&#93;</span></a></sup> and Firefox.<sup id="cite&#95;ref-103" class="reference"><a href="#cite_note-103"><span class="cite-bracket">&#91;</span>102<span class="cite-bracket">&#93;</span></a></sup> In Windows XP Service Pack 2, Microsoft demoted JScript's privileges in Internet Explorer.<sup id="cite&#95;ref-104" class="reference"><a href="#cite_note-104"><span class="cite-bracket">&#91;</span>103<span class="cite-bracket">&#93;</span></a></sup>
</p><p><a href="/wiki/Microsoft_Windows" title="Microsoft Windows">Microsoft Windows</a> allows JavaScript source files on a computer's hard drive to be launched as general-purpose, non-sandboxed programs (see: <a href="/wiki/Windows_Script_Host" title="Windows Script Host">Windows Script Host</a>). This makes JavaScript (like <a href="/wiki/VBScript" title="VBScript">VBScript</a>) a theoretically viable vector for a <a href="/wiki/Trojan_horse_(computing)" title="Trojan horse (computing)">Trojan horse</a>, although JavaScript Trojan horses are uncommon in practice.<sup id="cite&#95;ref-105" class="reference"><a href="#cite_note-105"><span class="cite-bracket">&#91;</span>104<span class="cite-bracket">&#93;</span></a></sup><sup class="noprint Inline-Template" style="white-space:nowrap;">&#91;<i><a href="/wiki/Wikipedia:Verifiability" title="Wikipedia:Verifiability"><span title="The material near this tag failed verification of its source citation(s). (March 2017)">failed verification</span></a></i>&#93;</sup>
</p>
<div class="mw-heading mw-heading3"><h3 id="Hardware_vulnerabilities">Hardware vulnerabilities</h3></div>
<p>In 2015, a JavaScript-based proof-of-concept implementation of a <a href="/wiki/Rowhammer" class="mw-redirect" title="Rowhammer">rowhammer</a> attack was described in a paper by security researchers.<sup id="cite&#95;ref-106" class="reference"><a href="#cite_note-106"><span class="cite-bracket">&#91;</span>105<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-107" class="reference"><a href="#cite_note-107"><span class="cite-bracket">&#91;</span>106<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-108" class="reference"><a href="#cite_note-108"><span class="cite-bracket">&#91;</span>107<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-109" class="reference"><a href="#cite_note-109"><span class="cite-bracket">&#91;</span>108<span class="cite-bracket">&#93;</span></a></sup>
</p><p>In 2017, a JavaScript-based attack via browser was demonstrated that could bypass <a href="/wiki/Address_space_layout_randomization" title="Address space layout randomization">ASLR</a>. It is called "ASLR⊕Cache" or AnC.<sup id="cite&#95;ref-110" class="reference"><a href="#cite_note-110"><span class="cite-bracket">&#91;</span>109<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-111" class="reference"><a href="#cite_note-111"><span class="cite-bracket">&#91;</span>110<span class="cite-bracket">&#93;</span></a></sup>
</p><p>In 2018, the paper that announced the <a href="/wiki/Spectre_(security_vulnerability)" title="Spectre (security vulnerability)">Spectre</a> attacks against Speculative Execution in Intel and other processors included a JavaScript implementation.<sup id="cite&#95;ref-112" class="reference"><a href="#cite_note-112"><span class="cite-bracket">&#91;</span>111<span class="cite-bracket">&#93;</span></a></sup>
</p>
...
<li>Some browsers have built-in <a href="/wiki/Profiling_(computer_programming)" title="Profiling (computer programming)">profilers</a>. Stand-alone profiling libraries have also been created, such as benchmark.js and jsbench.<sup id="cite&#95;ref-113" class="reference"><a href="#cite_note-113"><span class="cite-bracket">&#91;</span>112<span class="cite-bracket">&#93;</span></a></sup><sup id="cite&#95;ref-auto1&#95;114-0" class="reference"><a href="#cite_note-auto1-114"><span class="cite-bracket">&#91;</span>113<span class="cite-bracket">&#93;</span></a></sup></li>
...
<p>A common misconception is that JavaScript is directly related to <a href="/wiki/Java_(programming_language)" title="Java (programming language)">Java</a>. Both indeed have a C-like syntax (the C language being their most immediate common ancestor language). They are also typically <a href="/wiki/Sandbox_(computer_security)" title="Sandbox (computer security)">sandboxed</a>, and JavaScript was designed with Java's syntax and standard library in mind. In particular, all Java keywords were reserved in original JavaScript, JavaScript's standard library follows Java's naming conventions, and JavaScript's <code class="mw-highlight mw-highlight-lang-javascript mw-content-ltr" style="" dir="ltr"><span class="nb">Math</span></code> and <code class="mw-highlight mw-highlight-lang-javascript mw-content-ltr" style="" dir="ltr"><span class="nb">Date</span></code> objects are based on classes from Java 1.0.<sup id="cite&#95;ref-popularity&#95;115-0" class="reference"><a href="#cite_note-popularity-115"><span class="cite-bracket">&#91;</span>114<span class="cite-bracket">&#93;</span></a></sup>
</p><p>Both languages first appeared in 1995, but Java was developed by <a href="/wiki/James_Gosling" title="James Gosling">James Gosling</a> of Sun Microsystems and JavaScript by <a href="/wiki/Brendan_Eich" title="Brendan Eich">Brendan Eich</a> of Netscape Communications.
</p><p>The differences between the two languages are more prominent than their similarities. Java has <a href="/wiki/Static_typing" class="mw-redirect" title="Static typing">static typing</a>, while JavaScript's typing is <a href="/wiki/Dynamic_typing" class="mw-redirect" title="Dynamic typing">dynamic</a>. Java is loaded from <a href="/wiki/Compiler" title="Compiler">compiled</a> bytecode, while JavaScript is loaded as human-readable source code. Java's objects are <a href="/wiki/Class-based_programming" class="mw-redirect" title="Class-based programming">class-based</a>, while JavaScript's are <a href="/wiki/Prototype-based_programming" title="Prototype-based programming">prototype-based</a>. Finally, Java did not support functional programming until Java 8, while JavaScript has done so from the beginning, being influenced by <a href="/wiki/Scheme_(programming_language)" title="Scheme (programming language)">Scheme</a>.
</p>
<div class="mw-heading mw-heading3"><h3 id="JSON">JSON</h3></div>
<p><a href="/wiki/JSON" title="JSON">JSON</a> is a data format derived from JavaScript; hence the name JavaScript Object Notation. It is a widely used format supported by many other programming languages.
</p>
<div class="mw-heading mw-heading3"><h3 id="Transpilers">Transpilers</h3></div>
<p>Many websites are JavaScript-heavy, so <a href="/wiki/Transpiler" class="mw-redirect" title="Transpiler">transpilers</a> have been created to convert code written in other languages, which can aid the development process.<sup id="cite&#95;ref-transpilers&#95;37-1" class="reference"><a href="#cite_note-transpilers-37"><span class="cite-bracket">&#91;</span>36<span class="cite-bracket">&#93;</span></a></sup>
</p><p><a href="/wiki/TypeScript" title="TypeScript">TypeScript</a> and <a href="/wiki/CoffeeScript" title="CoffeeScript">CoffeeScript</a> are two notable languages that transpile to JavaScript.
</p>
<div class="mw-heading mw-heading3"><h3 id="WebAssembly">WebAssembly</h3></div>
<p><a href="/wiki/WebAssembly" title="WebAssembly">WebAssembly</a> is a newer language with a <a href="/wiki/Bytecode" title="Bytecode">bytecode</a> format designed to complement JavaScript, especially the performance-critical portions of <a href="/wiki/Web_page" title="Web page">web page</a> scripts. All of the major <a href="/wiki/JavaScript_engine" class="mw-redirect" title="JavaScript engine">JavaScript engines</a> support WebAssembly,<sup id="cite&#95;ref-116" class="reference"><a href="#cite_note-116"><span class="cite-bracket">&#91;</span>115<span class="cite-bracket">&#93;</span></a></sup> which runs in the same <a href="/wiki/Sandbox_(computer_security)" title="Sandbox (computer security)">sandbox</a> as regular JavaScript code.
</p><p><a href="/wiki/Asm.js" title="Asm.js">asm.js</a> is a subset of JavaScript that served as the forerunner of WebAssembly.<sup id="cite&#95;ref-117" class="reference"><a href="#cite_note-117"><span class="cite-bracket">&#91;</span>116<span class="cite-bracket">&#93;</span></a></sup>
</p>
...
<li id="cite&#95;note-57"><span class="mw-cite-backlink"><b><a href="#cite_ref-57">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://www.espruino.com/">"Espruino&#160;– JavaScript for Microcontrollers"</a>. <i>espruino.com</i>. <a rel="nofollow" class="external text" href="https://web.archive.org/web/20200501010722/https://www.espruino.com/">Archived</a> from the original on 1 May 2020<span class="reference-accessdate">. Retrieved <span class="nowrap">3 May</span> 2020</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Ajournal&amp;rft.genre=unknown&amp;rft.jtitle=espruino.com&amp;rft.atitle=Espruino+%E2%80%93+JavaScript+for+Microcontrollers&amp;rft&#95;id=https%3A%2F%2Fwww.espruino.com%2F&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-58"><span class="mw-cite-backlink"><b><a href="#cite_ref-58">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFLooper2015" class="citation web cs1">Looper, Jen (21 September 2015). <a rel="nofollow" class="external text" href="https://web.archive.org/web/20181208123231/http://developer.telerik.com/featured/a-guide-to-javascript-engines-for-idiots/">"A Guide to JavaScript Engines for Idiots"</a>. <a href="/wiki/Telerik" title="Telerik">Telerik</a> Developer Network. Archived from <a rel="nofollow" class="external text" href="http://developer.telerik.com/featured/a-guide-to-javascript-engines-for-idiots/">the original</a> on 8 December 2018<span class="reference-accessdate">. Retrieved <span class="nowrap">8 December</span> 2018</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=A+Guide+to+JavaScript+Engines+for+Idiots&amp;rft.pub=Telerik+Developer+Network&amp;rft.date=2015-09-21&amp;rft.aulast=Looper&amp;rft.aufirst=Jen&amp;rft&#95;id=http%3A%2F%2Fdeveloper.telerik.com%2Ffeatured%2Fa-guide-to-javascript-engines-for-idiots%2F&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-59"><span class="mw-cite-backlink"><b><a href="#cite_ref-59">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://docs.google.com/document/d/1aitSOucL0VHZa9Z2vbRJSyAIsAz24kX8LFByQ5xQnUg">"How Blink Works"</a><span class="reference-accessdate">. Retrieved <span class="nowrap">12 March</span> 2024</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=How+Blink+Works&amp;rft&#95;id=https%3A%2F%2Fdocs.google.com%2Fdocument%2Fd%2F1aitSOucL0VHZa9Z2vbRJSyAIsAz24kX8LFByQ5xQnUg&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-List&#95;of&#95;JavaScript&#95;engines&#95;v8&#95;doc-60"><span class="mw-cite-backlink">^ <a href="#cite_ref-List_of_JavaScript_engines_v8_doc_60-0"><sup><i><b>a</b></i></sup></a> <a href="#cite_ref-List_of_JavaScript_engines_v8_doc_60-1"><sup><i><b>b</b></i></sup></a></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://v8.dev/docs">"Documentation · V8"</a>. Google<span class="reference-accessdate">. Retrieved <span class="nowrap">3 March</span> 2024</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=Documentation+%C2%B7+V8&amp;rft.pub=Google&amp;rft&#95;id=https%3A%2F%2Fv8.dev%2Fdocs&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-List&#95;of&#95;JavaScript&#95;engines&#95;Wasm-61"><span class="mw-cite-backlink"><b><a href="#cite_ref-List_of_JavaScript_engines_Wasm_61-0">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFNelaturu2020" class="citation web cs1">Nelaturu, Keerthi (September 2020). <a rel="nofollow" class="external text" href="https://medium.com/coinmonks/webassembly-whats-the-big-deal-662396ff1cd6">"WebAssembly: What's the big deal?"</a>. <i>medium.com</i><span class="reference-accessdate">. Retrieved <span class="nowrap">3 March</span> 2024</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Ajournal&amp;rft.genre=unknown&amp;rft.jtitle=medium.com&amp;rft.atitle=WebAssembly%3A+What%27s+the+big+deal%3F&amp;rft.date=2020-09&amp;rft.aulast=Nelaturu&amp;rft.aufirst=Keerthi&amp;rft&#95;id=https%3A%2F%2Fmedium.com%2Fcoinmonks%2Fwebassembly-whats-the-big-deal-662396ff1cd6&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
...
<li id="cite&#95;note-71"><span class="mw-cite-backlink"><b><a href="#cite_ref-71">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFHerman2013" class="citation book cs1">Herman, David (2013). <a rel="nofollow" class="external text" href="https://books.google.com/books?id=Nz9iAwAAQBAJ&amp;pg=PA83"><i>Effective JavaScript</i></a>. Addison-Wesley. p.&#160;83. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-0-321-81218-6" title="Special:BookSources/978-0-321-81218-6"><bdi>978-0-321-81218-6</bdi></a>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=Effective+JavaScript&amp;rft.pages=83&amp;rft.pub=Addison-Wesley&amp;rft.date=2013&amp;rft.isbn=978-0-321-81218-6&amp;rft.aulast=Herman&amp;rft.aufirst=David&amp;rft&#95;id=https%3A%2F%2Fbooks.google.com%2Fbooks%3Fid%3DNz9iAwAAQBAJ%26pg%3DPA83&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-JavaScriptNext-72"><span class="mw-cite-backlink"><b><a href="#cite_ref-JavaScriptNext_72-0">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFGhandi2019" class="citation book cs1">Ghandi, Raju (2019). <i>JavaScript Next</i>. New York City: Apress Media. pp.&#160;<span class="nowrap">159–</span>171. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-1-4842-5394-6" title="Special:BookSources/978-1-4842-5394-6"><bdi>978-1-4842-5394-6</bdi></a>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=JavaScript+Next&amp;rft.place=New+York+City&amp;rft.pages=159-171&amp;rft.pub=Apress+Media&amp;rft.date=2019&amp;rft.isbn=978-1-4842-5394-6&amp;rft.aulast=Ghandi&amp;rft.aufirst=Raju&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-Haverbeke2024-73"><span class="mw-cite-backlink">^ <a href="#cite_ref-Haverbeke2024_73-0"><sup><i><b>a</b></i></sup></a> <a href="#cite_ref-Haverbeke2024_73-1"><sup><i><b>b</b></i></sup></a></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFHaverbeke2024" class="citation book cs1">Haverbeke, Marijn (September 2024). <a rel="nofollow" class="external text" href="https://eloquentjavascript.net/Eloquent_JavaScript.pdf"><i>Eloquent JavaScript</i></a> <span class="cs1-format">(PDF)</span> (4th&#160;ed.). San Francisco: <a href="/wiki/No_Starch_Press" title="No Starch Press">No Starch Press</a>. pp.&#160;<a rel="nofollow" class="external text" href="https://eloquentjavascript.net/Eloquent_JavaScript.pdf#section*.204">97–98</a>. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-1-71850-411-0" title="Special:BookSources/978-1-71850-411-0"><bdi>978-1-71850-411-0</bdi></a>. <a rel="nofollow" class="external text" href="https://web.archive.org/web/20250312193854/https://eloquentjavascript.net/Eloquent_JavaScript.pdf">Archived</a> <span class="cs1-format">(PDF)</span> from the original on 12 March 2025.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=Eloquent+JavaScript&amp;rft.place=San+Francisco&amp;rft.pages=97-98&amp;rft.edition=4th&amp;rft.pub=No+Starch+Press&amp;rft.date=2024-09&amp;rft.isbn=978-1-71850-411-0&amp;rft.aulast=Haverbeke&amp;rft.aufirst=Marijn&amp;rft&#95;id=https%3A%2F%2Feloquentjavascript.net%2FEloquent&#95;JavaScript.pdf&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-74"><span class="mw-cite-backlink"><b><a href="#cite_ref-74">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFKatz2011" class="citation web cs1">Katz, Yehuda (12 August 2011). <a rel="nofollow" class="external text" href="https://yehudakatz.com/2011/08/12/understanding-prototypes-in-javascript/">"Understanding "Prototypes" in JavaScript"</a>. <a rel="nofollow" class="external text" href="https://web.archive.org/web/20130405154842/https://yehudakatz.com/2011/08/12/understanding-prototypes-in-javascript/">Archived</a> from the original on 5 April 2013<span class="reference-accessdate">. Retrieved <span class="nowrap">6 April</span> 2013</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=Understanding+%22Prototypes%22+in+JavaScript&amp;rft.date=2011-08-12&amp;rft.aulast=Katz&amp;rft.aufirst=Yehuda&amp;rft&#95;id=https%3A%2F%2Fyehudakatz.com%2F2011%2F08%2F12%2Funderstanding-prototypes-in-javascript%2F&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-75"><span class="mw-cite-backlink"><b><a href="#cite_ref-75">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFHerman2013" class="citation book cs1">Herman, David (2013). <a rel="nofollow" class="external text" href="https://books.google.com/books?id=Nz9iAwAAQBAJ&amp;pg=PA125"><i>Effective JavaScript</i></a>. Addison-Wesley. pp.&#160;<span class="nowrap">125–</span>127. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-0-321-81218-6" title="Special:BookSources/978-0-321-81218-6"><bdi>978-0-321-81218-6</bdi></a>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=Effective+JavaScript&amp;rft.pages=125-127&amp;rft.pub=Addison-Wesley&amp;rft.date=2013&amp;rft.isbn=978-0-321-81218-6&amp;rft.aulast=Herman&amp;rft.aufirst=David&amp;rft&#95;id=https%3A%2F%2Fbooks.google.com%2Fbooks%3Fid%3DNz9iAwAAQBAJ%26pg%3DPA125&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-76"><span class="mw-cite-backlink"><b><a href="#cite_ref-76">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function">"Function&#160;– JavaScript"</a>. <i><a href="/wiki/MDN_Web_Docs" title="MDN Web Docs">MDN Web Docs</a></i><span class="reference-accessdate">. Retrieved <span class="nowrap">30 October</span> 2021</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Ajournal&amp;rft.genre=unknown&amp;rft.jtitle=MDN+Web+Docs&amp;rft.atitle=Function+%E2%80%93+JavaScript&amp;rft&#95;id=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FJavaScript%2FReference%2FGlobal&#95;Objects%2FFunction&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-77"><span class="mw-cite-backlink"><b><a href="#cite_ref-77">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://es5.github.com/#x15.3.4-toc">"Properties of the Function Object"</a>. Es5.github.com. <a rel="nofollow" class="external text" href="https://web.archive.org/web/20130128185825/https://es5.github.com/#x15.3.4-toc">Archived</a> from the original on 28 January 2013<span class="reference-accessdate">. Retrieved <span class="nowrap">26 May</span> 2013</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=Properties+of+the+Function+Object&amp;rft.pub=Es5.github.com&amp;rft&#95;id=https%3A%2F%2Fes5.github.com%2F%23x15.3.4-toc&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
<li id="cite&#95;note-FOOTNOTEFlanagan2006141-78"><span class="mw-cite-backlink"><b><a href="#cite_ref-FOOTNOTEFlanagan2006141_78-0">^</a></b></span> <span class="reference-text"><a href="#CITEREFFlanagan2006">Flanagan 2006</a>, p.&#160;141.</span>
</li>
<li id="cite&#95;note-79"><span class="mw-cite-backlink"><b><a href="#cite_ref-79">^</a></b></span> <span class="reference-text"><a rel="nofollow" class="external text" href="https://peterseliger.blogspot.de/2014/04/the-many-talents-of-javascript.html#the-many-talents-of-javascript-for-generalizing-role-oriented-programming-approaches-like-traits-and-mixins">The many talents of JavaScript for generalizing Role-Oriented Programming approaches like Traits and Mixins</a> <a rel="nofollow" class="external text" href="https://web.archive.org/web/20171005050713/https://peterseliger.blogspot.de/2014/04/the-many-talents-of-javascript.html#the-many-talents-of-javascript-for-generalizing-role-oriented-programming-approaches-like-traits-and-mixins">Archived</a> 2017-10-05 at the <a href="/wiki/Wayback_Machine" title="Wayback Machine">Wayback Machine</a>, Peterseliger.blogspot.de, April 11, 2014.</span>
</li>
<li id="cite&#95;note-80"><span class="mw-cite-backlink"><b><a href="#cite_ref-80">^</a></b></span> <span class="reference-text"><a rel="nofollow" class="external text" href="https://soft.vub.ac.be/~tvcutsem/traitsjs/">Traits for JavaScript</a> <a rel="nofollow" class="external text" href="https://web.archive.org/web/20140724052500/https://soft.vub.ac.be/~tvcutsem/traitsjs/">Archived</a> 2014-07-24 at the <a href="/wiki/Wayback_Machine" title="Wayback Machine">Wayback Machine</a>, 2010.</span>
</li>
...
<li id="cite&#95;note-117"><span class="mw-cite-backlink"><b><a href="#cite_ref-117">^</a></b></span> <span class="reference-text"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite class="citation web cs1"><a rel="nofollow" class="external text" href="https://asmjs.org/faq.html">"frequently asked questions"</a>. asm.js. <a rel="nofollow" class="external text" href="https://web.archive.org/web/20140604012024/https://asmjs.org/faq.html">Archived</a> from the original on 4 June 2014<span class="reference-accessdate">. Retrieved <span class="nowrap">13 April</span> 2014</span>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=unknown&amp;rft.btitle=frequently+asked+questions&amp;rft.pub=asm.js&amp;rft&#95;id=https%3A%2F%2Fasmjs.org%2Ffaq.html&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></span>
</li>
</ol></div></div>
<div class="mw-heading mw-heading2"><h2 id="Further_reading">Further reading</h2></div>
<link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1320445320" /><div role="note" class="hatnote navigation-not-searchable">See also: <a href="/wiki/ECMAScript#External_links" title="ECMAScript">ECMAScript Specification Documents</a></div>
<ul><li><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFFlanagan2020" class="citation book cs1">Flanagan, David (2020). <i>JavaScript: The Definitive Guide</i> (7th&#160;ed.). Sebastopol, California: O'Reilly. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-1-491-95202-3" title="Special:BookSources/978-1-491-95202-3"><bdi>978-1-491-95202-3</bdi></a>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=JavaScript%3A+The+Definitive+Guide&amp;rft.place=Sebastopol%2C+California&amp;rft.edition=7th&amp;rft.pub=O%27Reilly&amp;rft.date=2020&amp;rft.isbn=978-1-491-95202-3&amp;rft.aulast=Flanagan&amp;rft.aufirst=David&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></li>
<li><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFHaverbeke2024" class="citation book cs1">Haverbeke, Marijn (2024). <a rel="nofollow" class="external text" href="https://eloquentjavascript.net/Eloquent_JavaScript.pdf"><i>Eloquent JavaScript</i></a> <span class="cs1-format">(PDF)</span> (4th&#160;ed.). San Francisco: <a href="/wiki/No_Starch_Press" title="No Starch Press">No Starch Press</a>. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-1-71850-411-0" title="Special:BookSources/978-1-71850-411-0"><bdi>978-1-71850-411-0</bdi></a>. <a rel="nofollow" class="external text" href="https://web.archive.org/web/20250312193854/https://eloquentjavascript.net/Eloquent_JavaScript.pdf">Archived</a> <span class="cs1-format">(PDF)</span> from the original on 12 March 2025.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=Eloquent+JavaScript&amp;rft.place=San+Francisco&amp;rft.edition=4th&amp;rft.pub=No+Starch+Press&amp;rft.date=2024&amp;rft.isbn=978-1-71850-411-0&amp;rft.aulast=Haverbeke&amp;rft.aufirst=Marijn&amp;rft&#95;id=https%3A%2F%2Feloquentjavascript.net%2FEloquent&#95;JavaScript.pdf&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></li>
<li><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333433106" /><cite id="CITEREFZakas2014" class="citation book cs1">Zakas, Nicholas (2014). <i>Principles of Object-Oriented JavaScript</i> (1st&#160;ed.). No Starch Press. <a href="/wiki/ISBN_(identifier)" class="mw-redirect" title="ISBN (identifier)">ISBN</a>&#160;<a href="/wiki/Special:BookSources/978-1-59327-540-2" title="Special:BookSources/978-1-59327-540-2"><bdi>978-1-59327-540-2</bdi></a>.</cite><span title="ctx&#95;ver=Z39.88-2004&amp;rft&#95;val&#95;fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Abook&amp;rft.genre=book&amp;rft.btitle=Principles+of+Object-Oriented+JavaScript&amp;rft.edition=1st&amp;rft.pub=No+Starch+Press&amp;rft.date=2014&amp;rft.isbn=978-1-59327-540-2&amp;rft.aulast=Zakas&amp;rft.aufirst=Nicholas&amp;rfr&#95;id=info%3Asid%2Fen.wikipedia.org%3AJavaScript" class="Z3988"></span></li></ul>
...
<li><a href="/w/index.php?title=OxLint&amp;action=edit&amp;redlink=1" class="new" title="OxLint (page does not exist)">OxLint</a></li>
<li><a href="/wiki/Chous" title="Chous">Chous</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Subset" title="Subset">Subsets,* supersets</a></th><td class="navbox-list-with-group navbox-list navbox-even hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/Source_(programming_language)" title="Source (programming language)">Source</a>*</li>
<li><a href="/wiki/ArkTS" title="ArkTS">ArkTS</a></li>
...
<li><a href="/wiki/ReScript" title="ReScript">ReScript</a></li>
...
<li><a href="/w/index.php?title=JavaScript_stack&amp;action=edit&amp;redlink=1" class="new" title="JavaScript stack (page does not exist)">JavaScript stack</a></li></ul>
...
<li><a href="/wiki/Firefox" title="Firefox">Firefox</a> Inspector (formerly <a href="/wiki/Firebug_(software)" title="Firebug (software)">Firebug</a>)</li>
<li><a href="/wiki/Komodo_IDE" title="Komodo IDE">Komodo IDE</a></li>
<li><a href="/wiki/Safari_(web_browser)" title="Safari (web browser)">Safari</a> Web Inspector</li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Documentation_generator" title="Documentation generator">Documentation generators</a></th><td class="navbox-list-with-group navbox-list navbox-even hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/JSDoc" title="JSDoc">JSDoc</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">Editors (comparison)</th><td class="navbox-list-with-group navbox-list navbox-odd hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
...
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/JavaScript_engine" class="mw-redirect" title="JavaScript engine">Engines</a></th><td class="navbox-list-with-group navbox-list navbox-even hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/List_of_JavaScript_engines" title="List of JavaScript engines">List of JavaScript engines</a></li></ul>
...
<li><a href="/wiki/Pnpm" title="Pnpm">pnpm</a></li>
<li><a href="/wiki/Yarn_(package_manager)" title="Yarn (package manager)">yarn</a></li>
<li><a href="/wiki/Bun_(software)" title="Bun (software)">Bun</a></li></ul>
...
<ul><li><a href="/wiki/Bun_(software)" title="Bun (software)">Bun</a></li>
<li><a href="/wiki/Esbuild" title="Esbuild">esbuild</a></li>
<li><a href="/wiki/Vite_(software)" title="Vite (software)">Vite</a></li>
<li><a href="/wiki/Webpack" title="Webpack">Webpack</a></li></ul>
...
<li><a href="/wiki/Node.js" title="Node.js">Node.js</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Unit_testing" title="Unit testing">Unit testing</a> frameworks (<a href="/wiki/List_of_unit_testing_frameworks#JavaScript" title="List of unit testing frameworks">list</a>)</th><td class="navbox-list-with-group navbox-list navbox-even hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/Jasmine_(software)" title="Jasmine (software)">Jasmine</a></li>
...
<li><a href="/wiki/Jesse_James_Garrett" title="Jesse James Garrett">Jesse James Garrett</a></li></ul>
</div></td></tr><tr><td class="navbox-abovebelow hlist" colspan="2"><div>
<ul><li><a href="/wiki/Outline_of_the_JavaScript_programming_language" title="Outline of the JavaScript programming language">Outline</a></li>
<li><a href="/wiki/Index_of_JavaScript-related_articles" title="Index of JavaScript-related articles">Index</a></li>
<li><a href="https://en.wikibooks.org/wiki/JavaScript" class="extiw" title="b:JavaScript">Wikibook</a></li></ul>
...
<li><a class="mw-selflink selflink">JavaScript</a>
...
<li><a href="/wiki/ChatGPT_Atlas" title="ChatGPT Atlas">Atlas</a></li>
...
<li><a href="/wiki/Ungoogled-chromium" class="mw-redirect" title="Ungoogled-chromium">ungoogled</a></li></ul>
...
<li><a href="/wiki/SeaMonkey" title="SeaMonkey">SeaMonkey</a> (uses unnamed Gecko <a href="/wiki/Fork_(software_development)" title="Fork (software development)">fork</a>)</li>
...
<li><a href="/wiki/Zen_Browser" title="Zen Browser">Zen</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%"><a href="/wiki/Goanna_(software)" title="Goanna (software)">Goanna</a>-based</th><td class="navbox-list-with-group navbox-list navbox-even" style="width:100%;padding:0"><div style="padding:0 0.25em">
...
<li><a href="/wiki/Pale_Moon" title="Pale Moon">Pale Moon</a></li></ul>
...
<li><a href="/wiki/Kagi_(search_engine)#Orion_Browser" class="mw-redirect" title="Kagi (search engine)">Orion</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">Multi-<a href="/wiki/Browser_engine" title="Browser engine">engine</a></th><td class="navbox-list-with-group navbox-list navbox-even" style="width:100%;padding:0"><div style="padding:0 0.25em">
...
<li><a href="/wiki/Waterfox_Classic" class="mw-redirect" title="Waterfox Classic">Waterfox Classic</a></li>
...
<li><a href="/wiki/Google_TV_(2010%E2%80%932014)" title="Google TV (2010–2014)">Google TV</a></li>
...
<div class="navbox-styles"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333133064" /><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1314944253" /></div><div role="navigation" class="navbox" aria-labelledby="Node.js763" style="padding:3px"><table class="nowraplinks mw-collapsible autocollapse navbox-inner" style="border-spacing:0;background:transparent;color:inherit"><tbody><tr><th scope="col" class="navbox-title" colspan="3"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333133064" /><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1239400231" /><div class="navbar plainlinks hlist navbar-mini"><ul><li class="nv-view"><a href="/wiki/Template:NodeJs" title="Template:NodeJs"><abbr title="View this template">v</abbr></a></li><li class="nv-talk"><a href="/wiki/Template_talk:NodeJs" title="Template talk:NodeJs"><abbr title="Discuss this template">t</abbr></a></li><li class="nv-edit"><a href="/wiki/Special:EditPage/Template:NodeJs" title="Special:EditPage/Template:NodeJs"><abbr title="Edit this template">e</abbr></a></li></ul></div><div id="Node.js763" style="font-size:114%;margin:0 4em"><a href="/wiki/Node.js" title="Node.js">Node.js</a></div></th></tr><tr><th scope="row" class="navbox-group" style="width:1%">Platform</th><td class="navbox-list-with-group navbox-list navbox-odd hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/Node.js" title="Node.js">Node.js</a></li>
<li><a href="/wiki/V8_(JavaScript_engine)" title="V8 (JavaScript engine)">V8</a></li>
<li><a href="/wiki/CommonJS" title="CommonJS">CommonJS</a></li></ul>
</div></td><td class="noviewer navbox-image" rowspan="5" style="width:1px;padding:0 0 0 2px"><div><span typeof="mw:File"><a href="/wiki/File:Node.js_logo.svg" class="mw-file-description"><img src="//upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Node.js_logo.svg/120px-Node.js_logo.svg.png" decoding="async" width="100" height="61" class="mw-file-element" srcset="//upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Node.js_logo.svg/250px-Node.js_logo.svg.png 1.5x" data-file-width="590" data-file-height="361" /></a></span></div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">Packaging</th><td class="navbox-list-with-group navbox-list navbox-even hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/Npm" title="Npm">npm</a></li>
<li><a href="/wiki/Yarn_(package_manager)" title="Yarn (package manager)">yarn</a></li>
<li><a href="/wiki/Pnpm" title="Pnpm">pnpm</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">Frameworks</th><td class="navbox-list-with-group navbox-list navbox-odd hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/MEAN_(solution_stack)" title="MEAN (solution stack)">MEAN</a>
<ul><li><a href="/wiki/MongoDB" title="MongoDB">MongoDB</a></li>
<li><a href="/wiki/Express.js" title="Express.js">Express.js</a></li>
<li><a href="/wiki/AngularJS" title="AngularJS">AngularJS</a>/<a href="/wiki/Angular_(web_framework)" title="Angular (web framework)">Angular</a></li></ul></li>
<li>MEEN (substituted with <a href="/wiki/Ember.js" title="Ember.js">Ember.js</a>)</li>
...
<li><a href="/wiki/Sails.js" title="Sails.js">Sails.js</a> (uses Express.js)</li>
<li><a href="/wiki/NestJS" title="NestJS">NestJS</a></li>
<li><a href="/wiki/Next.js" title="Next.js">Next.js</a></li>
<li><a href="/wiki/Nuxt" title="Nuxt">Nuxt</a></li></ul>
</div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">Libraries</th><td class="navbox-list-with-group navbox-list navbox-even hlist" style="width:100%;padding:0"><div style="padding:0 0.25em">
<ul><li><a href="/wiki/Lodash" title="Lodash">Lodash</a></li>
<li><a href="/wiki/Underscore.js" title="Underscore.js">Underscore.js</a></li>
<li><a href="/wiki/React_(software)" title="React (software)">React</a></li>
<li><a href="/wiki/Vue.js" title="Vue.js">Vue.js</a></li></ul>
...
<ul><li><a class="mw-selflink selflink">JavaScript</a></li>
<li><a href="/wiki/CoffeeScript" title="CoffeeScript">CoffeeScript</a></li>
<li><a href="/wiki/ReScript" title="ReScript">ReScript</a></li>
<li><a href="/wiki/TypeScript" title="TypeScript">TypeScript</a></li>
<li><a href="/wiki/WebAssembly" title="WebAssembly">WebAssembly</a>
<ul><li><a href="/wiki/AssemblyScript" title="AssemblyScript">AssemblyScript</a></li>
<li><a href="/wiki/C_(programming_language)" title="C (programming language)">C</a></li>
<li><a href="/wiki/Rust_(programming_language)" title="Rust (programming language)">Rust</a></li></ul></li></ul>
</div></td></tr></tbody></table></div>
<div class="navbox-styles"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333133064" /><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1314944253" /></div><div role="navigation" class="navbox" aria-labelledby="Programming&#95;languages1932" style="padding:3px"><table class="nowraplinks hlist mw-collapsible expanded navbox-inner" style="border-spacing:0;background:transparent;color:inherit"><tbody><tr><th scope="col" class="navbox-title" colspan="2"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333133064" /><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1239400231" /><div class="navbar plainlinks hlist navbar-mini"><ul><li class="nv-view"><a href="/wiki/Template:Programming_languages" title="Template:Programming languages"><abbr title="View this template">v</abbr></a></li><li class="nv-talk"><a href="/wiki/Template_talk:Programming_languages" title="Template talk:Programming languages"><abbr title="Discuss this template">t</abbr></a></li><li class="nv-edit"><a href="/wiki/Special:EditPage/Template:Programming_languages" title="Special:EditPage/Template:Programming languages"><abbr title="Edit this template">e</abbr></a></li></ul></div><div id="Programming&#95;languages1932" style="font-size:114%;margin:0 4em"><a href="/wiki/Programming_language" title="Programming language">Programming languages</a></div></th></tr><tr><td class="navbox-abovebelow" colspan="2"><div>
...
<li><a class="mw-selflink selflink">JavaScript</a></li>
...
<ul><li><a href="/wiki/OCaml" title="OCaml">OCaml</a></li></ul></li>
<li><a href="/wiki/Standard_ML" title="Standard ML">Standard ML</a></li></ul></li>
...
<div class="navbox-styles"><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1333133064" /><link rel="mw-deduplicated-inline-style" href="mw-data:TemplateStyles:r1314944253" /><style data-mw-deduplicate="TemplateStyles:r1038841319">.mw-parser-output .tooltip-dotted{border-bottom:1px dotted;cursor:help}</style></div><div role="navigation" class="navbox authority-control" aria-labelledby="Authority&#95;control&#95;databases&#95;frameless&amp;#124;text-top&amp;#124;10px&amp;#124;alt=Edit&#95;this&#95;at&#95;Wikidata&amp;#124;link=https&amp;#58;//www.wikidata.org/wiki/Q2005#identifiers&amp;#124;class=noprint&amp;#124;Edit&#95;this&#95;at&#95;Wikidata1496" style="padding:3px"><table class="nowraplinks hlist mw-collapsible autocollapse navbox-inner" style="border-spacing:0;background:transparent;color:inherit"><tbody><tr><th scope="col" class="navbox-title" colspan="2"><div id="Authority&#95;control&#95;databases&#95;frameless&amp;#124;text-top&amp;#124;10px&amp;#124;alt=Edit&#95;this&#95;at&#95;Wikidata&amp;#124;link=https&amp;#58;//www.wikidata.org/wiki/Q2005#identifiers&amp;#124;class=noprint&amp;#124;Edit&#95;this&#95;at&#95;Wikidata1496" style="font-size:114%;margin:0 4em"><a href="/wiki/Help:Authority_control" title="Help:Authority control">Authority control databases</a> <span class="mw-valign-text-top noprint" typeof="mw:File/Frameless"><a href="https://www.wikidata.org/wiki/Q2005#identifiers" title="Edit this at Wikidata"><img alt="Edit this at Wikidata" src="//upload.wikimedia.org/wikipedia/en/thumb/8/8a/OOjs_UI_icon_edit-ltr-progressive.svg/20px-OOjs_UI_icon_edit-ltr-progressive.svg.png" decoding="async" width="10" height="10" class="mw-file-element" data-file-width="20" data-file-height="20" /></a></span></div></th></tr><tr><th scope="row" class="navbox-group" style="width:1%">International</th><td class="navbox-list-with-group navbox-list navbox-odd" style="width:100%;padding:0"><div style="padding:0 0.25em"><ul><li><span class="uid"><a rel="nofollow" class="external text" href="https://d-nb.info/gnd/4420180-1">GND</a></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://id.worldcat.org/fast/982071">FAST</a></span></li></ul></div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">National</th><td class="navbox-list-with-group navbox-list navbox-even" style="width:100%;padding:0"><div style="padding:0 0.25em"><ul><li><span class="uid"><a rel="nofollow" class="external text" href="https://id.loc.gov/authorities/sh96004880">United States</a></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://catalogue.bnf.fr/ark:/12148/cb12549978q">France</a></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://data.bnf.fr/ark:/12148/cb12549978q">BnF data</a></span></li><li><span class="uid"><span class="rt-commentedText tooltip tooltip-dotted" title="JavaScript (programovací jazyk)"><a rel="nofollow" class="external text" href="https://aleph.nkp.cz/F/?func=find-c&amp;local_base=aut&amp;ccl_term=ica=ph117651&amp;CON_LNG=ENG">Czech Republic</a></span></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://datos.bne.es/resource/XX542465">Spain</a></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://www.nli.org.il/en/authorities/987007551493605171">Israel</a></span></li></ul></div></td></tr><tr><th scope="row" class="navbox-group" style="width:1%">Other</th><td class="navbox-list-with-group navbox-list navbox-odd" style="width:100%;padding:0"><div style="padding:0 0.25em"><ul><li><span class="uid"><a rel="nofollow" class="external text" href="https://www.idref.fr/034781870">IdRef</a></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://elmcip.net/node/10258">ELMCIP</a></span></li><li><span class="uid"><a rel="nofollow" class="external text" href="https://lux.collections.yale.edu/view/concept/364c16f5-7abc-42bb-aaa6-aefc12a5ffde">Yale LUX</a></span></li></ul></div></td></tr></tbody></table></div>
<!-- 
NewPP limit report
Parsed by mw‐api‐int.codfw.main‐75589dd6f6‐t75rd
Cached time: 20260211144530
Cache expiry: 1801
Reduced expiry: true
Complications: [vary‐revision‐sha1, show‐toc]
CPU time usage: 2.002 seconds
Real time usage: 2.489 seconds
Preprocessor visited node count: 9479/1000000
Revision size: 86273/2097152 bytes
Post‐expand include size: 316763/2097152 bytes
Template argument size: 10669/2097152 bytes
Highest expansion depth: 21/100
Expensive parser function count: 48/500
Unstrip recursion depth: 1/20
Unstrip post‐expand size: 453445/5000000 bytes
Lua time usage: 1.190/10.000 seconds
Lua memory usage: 12481312/52428800 bytes
Number of Wikibase entities loaded: 1/500
-->
<!--
Transclusion expansion time report (%,ms,calls,template)
100.00% 2045.803      1 -total
 26.06%  533.189      2 Template:Reflist
 19.26%  394.019      2 Template:Infobox
 17.48%  357.695      1 Template:Infobox_programming_language
 15.75%  322.265     77 Template:Cite_web
 11.38%  232.797      1 Template:Infobox_software/simple
  9.30%  190.247      4 Template:Wikidata
  5.35%  109.485      1 Template:Short_description
  5.33%  108.967      5 Template:Navbox
  4.52%   92.410      1 Template:Efn
-->

<!-- Saved in parser cache with key enwiki:pcache:9845:|#|:idhash:canonical and timestamp 20260211144530 and revision id 1330436866. Rendering was triggered because: api-parse
 -->
...
<footer id="footer" class="mw-footer" >
	<ul id="footer-info">
	<li id="footer-info-lastmod"> This page was last edited on 31 December 2025, at 11:19<span class="anonymous-show">&#160;(UTC)</span>.</li>
...
additional terms may apply. By using this site, you agree to the <a href="https://foundation.wikimedia.org/wiki/Special:MyLanguage/Policy:Terms_of_Use" class="extiw" title="foundation:Special:MyLanguage/Policy:Terms of Use">Terms of Use</a> and <a href="https://foundation.wikimedia.org/wiki/Special:MyLanguage/Policy:Privacy_policy" class="extiw" title="foundation:Special:MyLanguage/Policy:Privacy policy">Privacy Policy</a>. Wikipedia® is a registered trademark of the <a rel="nofollow" class="external text" href="https://wikimediafoundation.org/">Wikimedia Foundation, Inc.</a>, a non-profit organization.</li>
	...
	<li id="footer-places-mobileview"><a href="//en.wikipedia.org/w/index.php?title=JavaScript&amp;mobileaction=toggle_view_mobile" class="noprint stopMobileRedirectToggle">Mobile view</a></li>
</ul>
...
<span class="vector-dropdown-label-text">Toggle the table of contents</span>
				...
				<div class="vector-sticky-header-context-bar-primary" aria-hidden="true" ><span class="mw-page-title-main">JavaScript</span></div>
			</div>
		</div>
...
<script>(RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgHostname":"mw-web.codfw.main-76c55864-df66d","wgBackendResponseTime":233,"wgPageParseReport":{"limitreport":{"cputime":"2.002","walltime":"2.489","ppvisitednodes":{"value":9479,"limit":1000000},"revisionsize":{"value":86273,"limit":2097152},"postexpandincludesize":{"value":316763,"limit":2097152},"templateargumentsize":{"value":10669,"limit":2097152},"expansiondepth":{"value":21,"limit":100},"expensivefunctioncount":{"value":48,"limit":500},"unstrip-depth":{"value":1,"limit":20},"unstrip-size":{"value":453445,"limit":5000000},"entityaccesscount":{"value":1,"limit":500},"timingprofile":["100.00% 2045.803      1 -total"," 26.06%  533.189      2 Template:Reflist"," 19.26%  394.019      2 Template:Infobox"," 17.48%  357.695      1 Template:Infobox_programming_language"," 15.75%  322.265     77 Template:Cite_web"," 11.38%  232.797      1 Template:Infobox_software/simple","  9.30%  190.247      4 Template:Wikidata","  5.35%  109.485      1 Template:Short_description","  5.33%  108.967      5 Template:Navbox","  4.52%   92.410      1 Template:Efn"]},"scribunto":{"limitreport-timeusage":{"value":"1.190","limit":"10.000"},"limitreport-memusage":{"value":12481312,"limit":52428800},"limitreport-logs":"anchor_id_list = table#1 {\n    [\"CITEREFAndersen2004\"] = 1,\n    [\"CITEREFAshkenas\"] = 1,\n    [\"CITEREFAuerbach2015\"] = 1,\n    [\"CITEREFBaker2004\"] = 1,\n    [\"CITEREFBernhardt2012\"] = 1,\n    [\"CITEREFBranscombe2016\"] = 1,\n    [\"CITEREFBrown2017\"] = 1,\n    [\"CITEREFChampeon2001\"] = 1,\n    [\"CITEREFClaburn2024\"] = 1,\n    [\"CITEREFClinick2000\"] = 1,\n    [\"CITEREFCollins2016\"] = 1,\n    [\"CITEREFCrockford\"] = 1,\n    [\"CITEREFCroll2011\"] = 1,\n    [\"CITEREFEich1998\"] = 1,\n    [\"CITEREFEich2008\"] = 1,\n    [\"CITEREFEnzer2018\"] = 1,\n    [\"CITEREFFesta1998\"] = 1,\n    [\"CITEREFFin_JS2016\"] = 1,\n    [\"CITEREFFlanagan2006\"] = 1,\n    [\"CITEREFFlanagan2020\"] = 1,\n    [\"CITEREFGhandi2019\"] = 1,\n    [\"CITEREFGoodin2015\"] = 1,\n    [\"CITEREFGrussMauriceMangard2015\"] = 1,\n    [\"CITEREFHan2024\"] = 1,\n    [\"CITEREFHaverbeke2024\"] = 2,\n    [\"CITEREFHerman2013\"] = 2,\n    [\"CITEREFJSBEN.CH\"] = 1,\n    [\"CITEREFJean-Pharuns2015\"] = 1,\n    [\"CITEREFKatz2011\"] = 1,\n    [\"CITEREFKorolev2019\"] = 1,\n    [\"CITEREFKottelin2008\"] = 1,\n    [\"CITEREFKrill2024\"] = 1,\n    [\"CITEREFLauingerChaabaneArshadRobertson2016\"] = 1,\n    [\"CITEREFLawton2018\"] = 1,\n    [\"CITEREFMahemoff,_Michael2009\"] = 1,\n    [\"CITEREFMcCracken2010\"] = 1,\n    [\"CITEREFPonge2018\"] = 1,\n    [\"CITEREFPurdy2009\"] = 1,\n    [\"CITEREFRehorik2016\"] = 1,\n    [\"CITEREFSeibel2009\"] = 1,\n    [\"CITEREFWeber2005\"] = 1,\n    [\"CITEREFZakas2014\"] = 1,\n    [\"CITEREFtreitter2013\"] = 1,\n    [\"Server-side_JavaScript\"] = 1,\n    [\"Uses_outside_web_pages\"] = 1,\n    [\"moz_const\"] = 1,\n    [\"moz_let\"] = 1,\n}\ntemplate_list = table#1 {\n    [\"Anchor\"] = 1,\n    [\"Authority control\"] = 1,\n    [\"Blockquote\"] = 1,\n    [\"Citation\"] = 2,\n    [\"Cite arXiv\"] = 1,\n    [\"Cite book\"] = 10,\n    [\"Cite magazine\"] = 2,\n    [\"Cite news\"] = 7,\n    [\"Cite press release\"] = 1,\n    [\"Cite web\"] = 73,\n    [\"Code\"] = 3,\n    [\"Distinguish\"] = 1,\n    [\"ECMAScript\"] = 1,\n    [\"Efn\"] = 1,\n    [\"Excerpt\"] = 1,\n    [\"Failed verification\"] = 1,\n    [\"Further\"] = 2,\n    [\"IPAc-en\"] = 1,\n    [\"Infobox programming language\"] = 1,\n    [\"JavaScript\"] = 1,\n    [\"Main\"] = 19,\n    [\"NodeJs\"] = 1,\n    [\"Notelist\"] = 1,\n    [\"Plain image with caption\"] = 1,\n    [\"Portal bar\"] = 1,\n    [\"Pp-semi-indef\"] = 1,\n    [\"Programming languages\"] = 1,\n    [\"Quote box\"] = 1,\n    [\"R\"] = 1,\n    [\"Reflist\"] = 1,\n    [\"See also\"] = 2,\n    [\"Sfn\"] = 2,\n    [\"Short description\"] = 1,\n    [\"Sister project links\"] = 1,\n    [\"Spoken Wikipedia\"] = 1,\n    [\"Start date and age\"] = 3,\n    [\"URL\"] = 1,\n    [\"Use dmy dates\"] = 1,\n    [\"Web browsers\"] = 1,\n    [\"Webarchive\"] = 15,\n    [\"Wikidata\"] = 4,\n}\narticle_whitelist = table#1 {\n}\nciteref_patterns = table#1 {\n}\n"},"cachereport":{"origin":"mw-api-int.codfw.main-75589dd6f6-t75rd","timestamp":"20260211144530","ttl":1801,"transientcontent":true}}});});</script>
<script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"Article","name":"JavaScript","url":"https:\/\/en.wikipedia.org\/wiki\/JavaScript","sameAs":"http:\/\/www.wikidata.org\/entity\/Q2005","mainEntity":"http:\/\/www.wikidata.org\/entity\/Q2005","author":{"@type":"Organization","name":"Contributors to Wikimedia projects"},"publisher":{"@type":"Organization","name":"Wikimedia Foundation, Inc.","logo":{"@type":"ImageObject","url":"https:\/\/www.wikimedia.org\/static\/images\/wmf-hor-googpub.png"}},"datePublished":"2001-11-19T00:23:45Z","dateModified":"2025-12-31T11:19:20Z","image":"https:\/\/upload.wikimedia.org\/wikipedia\/commons\/a\/a4\/JavaScript_code.png","headline":"high-level programming language"}</script>
</body>
</html>